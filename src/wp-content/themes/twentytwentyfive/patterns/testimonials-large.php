    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group" style="min-height:100%">
                ...
                <h2 class="wp-block-heading is-style-text-annotation has-x-small-font-size"><?php echo esc_html_x('What people are saying',
                        'Testimonial heading', 'twentytwentyfive'); ?></h2>
                <!-- /wp:heading -->
                ...
                <blockquote class="wp-block-quote is-style-plain has-x-large-font-size"
                    ...
                    <div class="wp-block-group"
                        ...
                        <p class="has-xx-large-font-size"><?php echo esc_html_x('&ldquo;Superb product and customer service!&rdquo;',
        ...
        <div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
            ...
            <figure class="wp-block-image size-large"><img
                    src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/team-photo-3.webp"
                    alt="<?php echo esc_attr_x('Picture of a person', 'Alt text for testimonial image',
                        'twentytwentyfive'); ?>" style="aspect-ratio:1;object-fit:cover"/></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    </div>
