                    ...
                    <div class="wp-block-columns is-not-stacked-on-mobile"
                        ...
                        <div class="wp-block-column" style="flex-basis:66.66%">
                            ...
                            <div class="wp-block-group">
                                ...
                                <div class="wp-block-group">
                                    <!-- wp:heading {"level":4} -->
                                    <h4 class="wp-block-heading"><a href="#">Fauna from North America and its
                    ...
                    <div class="wp-block-columns is-not-stacked-on-mobile"
                        ...
                        <div class="wp-block-column" style="flex-basis:33.33%">
                            ...
                            <figure class="wp-block-image size-full"><img
                                    ...
                                    alt="View of the deep ocean." class="wp-image-2772"
                        ...
                        <div class="wp-block-column" style="flex-basis:66.66%">
                            ...
                            <div class="wp-block-group">
                                ...
                                <div class="wp-block-group">
                                    <!-- wp:heading {"level":4} -->
                                    <h4 class="wp-block-heading"><a href="#">Things you didn’t know about the deep
                                            ocean</a></h4>
                                    <!-- /wp:heading -->
                                    <!-- wp:paragraph -->
                                    <p>9 AM — 11 AM</p>
                ...
                <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:60%">
                    ...
                    <div class="wp-block-columns is-not-stacked-on-mobile"
                        ...
                        <div class="wp-block-column" style="flex-basis:33.33%">
                            ...
                            <figure class="wp-block-image size-full"><img
                                    ...
                                    alt="The acropolis in Athens." class="wp-image-2773"
                                    style="aspect-ratio:1;object-fit:cover"/></figure>
                            <!-- /wp:image -->
                        </div>
                        <!-- /wp:column -->
                    ...
                    <div class="wp-block-columns is-not-stacked-on-mobile"
                        ...
                        <div class="wp-block-column" style="flex-basis:33.33%">
                            ...
                            <figure class="wp-block-image size-full"><img
                                    src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/agenda-img-4.webp"
                                    alt="Black and white photo of an african woman." class="wp-image-2774"
                                    style="aspect-ratio:1;object-fit:cover"/></figure>
                            <!-- /wp:image -->
                        </div>
                        <!-- /wp:column -->
                        ...
                        <div class="wp-block-column" style="flex-basis:66.66%">
                            ...
                            <div class="wp-block-group">
                                ...
                                <div class="wp-block-group">
                                    <!-- wp:heading {"level":4} -->
                                    <h4 class="wp-block-heading"><a href="#">An introduction to African dialects</a>
                                    </h4>
                                    <!-- /wp:heading -->
                                    <!-- wp:paragraph -->
                                    <p>9 AM — 11 AM</p>
