    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column is-vertically-aligned-top">
            ...
            <div class="wp-block-group" style="min-height:100%">
                <!-- wp:paragraph {"className":"is-style-text-display","fontSize":"xx-large"} -->
                <p class="is-style-text-display has-xx-large-font-size">Visit us at 123 Example St. Manhattan, NY 10300,
                    United States</p>
                <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column is-vertically-aligned-top">
            ...
            <figure class="wp-block-image size-large"><img
                    src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/location.webp"
                    alt="The business location"/></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    </div>
