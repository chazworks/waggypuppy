...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;">
    ...
    <div class="wp-block-group"
        ...
        <div class="wp-block-query alignwide">
            ...
            <p class="has-text-align-center"><?php echo esc_html_x('Sorry, but nothing was found. Please try a search with different keywords.',
    ...
    <div class="wp-block-group alignwide"
        ...
        <div class="wp-block-query alignwide">
            ...
            <div class="wp-block-group alignfull"
                 style="border-bottom-color:var(--wp--preset--color--accent-6);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
