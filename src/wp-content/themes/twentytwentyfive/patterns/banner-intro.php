...
<div class="wp-block-group alignfull"
    ...
    <h2 class="wp-block-heading alignwide has-x-large-font-size">
        ...
        /* translators: %1$s is the brand name, e.g., 'Fleurs'. */
            esc_html_x('We\'re %1$s, our mission is to deliver exquisite flower arrangements that not only adorn living spaces but also inspire a deeper appreciation for natural beauty.',
                'Example pattern text', 'twentytwentyfive'),
