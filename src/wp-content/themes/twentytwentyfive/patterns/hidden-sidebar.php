...
<h2 class="wp-block-heading has-small-font-size"
    style="font-style:normal;font-weight:600;letter-spacing:1.6px;text-transform:uppercase"><?php esc_html_e('Other Posts',
        'twentytwentyfive'); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-query">
    ...
    <p class="has-medium-font-size"><?php esc_html_e('Sorry, but nothing was found. Please try a search with different keywords.',
            'twentytwentyfive'); ?></p>
    <!-- /wp:paragraph -->
    <!-- /wp:query-no-results -->
</div>
