...
<div class="wp-block-group alignfull">
    ...
    <div class="wp-block-group alignwide"
        ...
        <h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html_x('Frequently Asked Questions',
                'Heading of the FAQs', 'twentytwentyfive'); ?></h2>
        <!-- /wp:heading -->
        ...
        <div class="wp-block-group">
            ...
            <details class="wp-block-details"
                     style="border-bottom-color:var(--wp--preset--color--accent-6);border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--30);font-style:normal;font-weight:400">
                <summary><?php echo esc_html_x('What is The Stories Book about?', 'Question in the FAQs pattern',
                        'twentytwentyfive'); ?></summary>
            ...
            <details class="wp-block-details"
                     style="border-bottom-color:var(--wp--preset--color--accent-6);border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--30);font-style:normal;font-weight:400">
                <summary><?php echo esc_html_x('How much does The Stories Book cost?', 'Question in the FAQs pattern',
                        'twentytwentyfive'); ?></summary>
                <!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"300"}}} -->
                <p style="font-style:normal;font-weight:300"><?php echo esc_html_x('This exquisite compilation showcases a diverse array of photographs that capture the essence of different eras and cultures, reflecting the unique styles and perspectives of each artist. Fleckenstein\'s evocative imagery, Strand\'s groundbreaking modernist approach, and Kōno\'s meticulous documentation of Japanese life come together in a harmonious blend that celebrates the art of photography.',
                        'Answer in the FAQs pattern', 'twentytwentyfive'); ?></p>
            ...
            <details class="wp-block-details"
                     style="border-bottom-color:var(--wp--preset--color--accent-6);border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--30);font-style:normal;font-weight:400">
                <summary><?php echo esc_html_x('When will The Stories Book be released?',
                        'Question in the FAQs pattern', 'twentytwentyfive'); ?></summary>
                <!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"300"}}} -->
                <p style="font-style:normal;font-weight:300"><?php echo esc_html_x('This exquisite compilation showcases a diverse array of photographs that capture the essence of different eras and cultures, reflecting the unique styles and perspectives of each artist. Fleckenstein\'s evocative imagery, Strand\'s groundbreaking modernist approach, and Kōno\'s meticulous documentation of Japanese life come together in a harmonious blend that celebrates the art of photography.',
                        'Answer in the FAQs pattern', 'twentytwentyfive'); ?></p>
                <!-- /wp:paragraph -->
            ...
            <details class="wp-block-details"
                     style="border-bottom-color:var(--wp--preset--color--accent-6);border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--30);font-style:normal;font-weight:400">
                <summary><?php echo esc_html_x('Are signed copies available?', 'Question in the FAQs pattern',
                        'twentytwentyfive'); ?></summary>
                <!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"300"}}} -->
                <p style="font-style:normal;font-weight:300"><?php echo esc_html_x('This exquisite compilation showcases a diverse array of photographs that capture the essence of different eras and cultures, reflecting the unique styles and perspectives of each artist. Fleckenstein\'s evocative imagery, Strand\'s groundbreaking modernist approach, and Kōno\'s meticulous documentation of Japanese life come together in a harmonious blend that celebrates the art of photography.',
                        'Answer in the FAQs pattern', 'twentytwentyfive'); ?></p>
            ...
            <details class="wp-block-details" style="font-style:normal;font-weight:400">
                <summary><?php echo esc_html_x('Will The Stories Book be available in other languages other that English?',
                        'Question in the FAQs pattern', 'twentytwentyfive'); ?></summary>
                <!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"300"}}} -->
                <p style="font-style:normal;font-weight:300"><?php echo esc_html_x('This exquisite compilation showcases a diverse array of photographs that capture the essence of different eras and cultures, reflecting the unique styles and perspectives of each artist. Fleckenstein\'s evocative imagery, Strand\'s groundbreaking modernist approach, and Kōno\'s meticulous documentation of Japanese life come together in a harmonious blend that celebrates the art of photography.',
                        'Answer in the FAQs pattern', 'twentytwentyfive'); ?></p>
