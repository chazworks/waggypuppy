...
<div class="wp-block-cover alignfull has-contrast-color has-text-color has-link-color"
    ...
    <span aria-hidden="true"
          ...
          style="background:linear-gradient(180deg,rgb(251,250,243) 51%,rgb(255,255,255) 51%)"></span>
            ...
            <div class="wp-block-columns alignwide are-vertically-aligned-top">
                    ...
                    <div class="wp-block-group">
                        ...
                        <div class="wp-block-group">
                            ...
                            <h2 class="wp-block-heading has-xx-large-font-size">
                                <?php echo esc_html_x('The Stories Book',
                                    'Hero - Overlapped book cover pattern headline text', 'twentytwentyfive'); ?>
                            </h2>
                            <!-- /wp:heading -->
                            <!-- wp:paragraph {"className":"is-style-text-subtitle"} -->
                            <p class="is-style-text-subtitle">
                                <?php echo esc_html_x('A fine collection of moments in time featuring photographs from Louis Fleckenstein, Paul Strand and Asahachi Kōno.',
                                    'Hero - Overlapped book cover pattern subline text', 'twentytwentyfive'); ?>
                            </p>
                            <!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:group -->
                        ...
                        <div class="wp-block-group">
                                    ...
                                    <div class="wp-block-buttons">
                                        ...
                                        <div
                                            ...
                                            <a class="wp-block-button__link wp-element-button" href="#">
                                                <?php echo esc_html_x('Amazon',
                                                    'Hero - Overlapped book cover pattern button 1',
                                                    'twentytwentyfive'); ?>
                                            </a>
                                        </div>
                                        <!-- /wp:button -->
                                        ...
                                        <div
                                            class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill">
                                            <a class="wp-block-button__link wp-element-button" href="#">
                                                <?php echo esc_html_x('Apple Books',
                                                    'Hero - Overlapped book cover pattern button 2',
                                                    'twentytwentyfive'); ?>
                                            </a>
                                        </div>
                                        <!-- /wp:button -->
                                ...
                                <div class="wp-block-column is-vertically-aligned-stretch">
                                    ...
                                    <div class="wp-block-buttons">
                                        ...
                                        <div
                                            class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill">
                                            <a class="wp-block-button__link wp-element-button" href="#">
                                                <?php echo esc_html_x('Audible',
                                                    'Hero - Overlapped book cover pattern button 3',
                                                    'twentytwentyfive'); ?>
                                            </a>
                                        </div>
                                        <!-- /wp:button -->
                                        ...
                                        <div
                                            class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill">
                                            <a class="wp-block-button__link wp-element-button" href="#">
                                                <?php echo esc_html_x('Barnes & Noble',
                                                    'Hero - Overlapped book cover pattern button 4',
                                                    'twentytwentyfive'); ?>
                                            </a>
                                        </div>
                                        <!-- /wp:button -->
                            ...
                            <p class="has-medium-font-size">
                                <?php echo wp_kses_post(_x('Outside Europe? View <a href="#" rel="nofollow">international editions</a>.',
                                    'Hero - Overlapped book cover pattern bottom text', 'twentytwentyfive')); ?>
                            </p>
                            <!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:group -->
                ...
                <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:45%">
                    ...
                    <figure class="wp-block-image size-full">
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/book-image.webp"
                             alt="<?php echo esc_attr__('Book Image', 'twentytwentyfive'); ?>"
