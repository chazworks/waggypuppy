...
function twentyeleven_theme_options_help() {
	...
	$sidebar = '<p><strong>' . __( 'For more information:', 'twentyeleven' ) . '</strong></p>' .
		'<p>' . __( '<a href="https://__VAR_WP.org/documentation/article/customizer/" target="_blank">Documentation on Theme Customization</a>', 'twentyeleven' ) . '</p>' .
		'<p>' . __( '<a href="https://__VAR_WP.org/support/forums/" target="_blank">Support forums</a>', 'twentyeleven' ) . '</p>';
