...
?>
<form role="search" <?php echo $twentytwenty_aria_label; // phpcs:ignore __VAR_WP.Security.EscapeOutput.OutputNotEscaped -- Escaped above. ?> method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
