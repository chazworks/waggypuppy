 ...
 * Description: A footer section with a centered logo, navigation, and WP credits.
 */
?>
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50)">
    ...
    <?php
    /* Translators: WP link. */
        $wordpress_link = '<a href="' . esc_url(__('https://wp.org', 'twentytwentyfour')) . '" rel="nofollow">WP</a>';
        echo sprintf(
            /* Translators: Designed with WP */
