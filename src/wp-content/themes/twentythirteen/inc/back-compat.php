 ...
 *
 * Prevents Twenty Thirteen from running on WP versions prior to 3.6,
...
/**
 * Prevent switching to Twenty Thirteen on old versions of WP.
 *
 ...
 * Twenty Thirteen on WP versions prior to 3.6.
 *
 * @since Twenty Thirteen 1.0
 */
function twentythirteen_upgrade_notice()
{
    printf(
        ...
        sprintf(
            ...
            __('Twenty Thirteen requires at least WP version 3.6. You are running version %s. Please upgrade and try again.', 'twentythirteen'),
            $GLOBALS['wp_version']
        )
    );
}
...
/**
 * Prevent the Customizer from being loaded on WP versions prior to 3.6.
 *
 * @since Twenty Thirteen 1.0
 */
...
/**
 * Prevent the Theme Preview from being loaded on WP versions prior to 3.4.
 *
 * @since Twenty Thirteen 1.0
 */
