        ...
        'posts' => [
            'front' => [
                ...
                'post_content' => '
					...
					<figure class="wp-block-image alignfull size-large"><img src="'
					...
					<figure class="wp-block-image alignfull size-large is-style-twentytwentyone-image-frame"><img src="'
                    . esc_url(get_template_directory_uri())
					...
					<figure class="wp-block-image size-large alignfull size-full is-style-twentytwentyone-border"><img src="'
                    . esc_url(get_template_directory_uri())
					...
					<!-- wp:paragraph -->
					<p>'
                    . esc_html_x('Block patterns are pre-designed groups of blocks. To add one, select the Add Block button [+] in the toolbar at the top of the editor. Switch to the Patterns tab underneath the search bar, and choose a pattern.',
                        'Theme starter content', 'twentytwentyone')
                    . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->
					...
					<!-- wp:paragraph -->
					<p>'
                    . esc_html_x('Twenty Twenty-One includes stylish borders for your content. With an Image block selected, open the "Styles" panel within the Editor sidebar. Select the "Frame" block style to activate it.',
                        'Theme starter content', 'twentytwentyone')
                    . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->
					...
					<!-- wp:paragraph -->
					<p>'
                    . esc_html_x('Twenty Twenty-One also includes an overlap style for column blocks. With a Columns block selected, open the "Styles" panel within the Editor sidebar. Choose the "Overlap" block style to try it out.',
                        'Theme starter content', 'twentytwentyone')
                    . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column --></div>
					...
					<p><a href="https://wp.org/documentation/article/twenty-twenty-one/">'
					...
					<!-- wp:column -->
					<div class="wp-block-column"><!-- wp:paragraph -->
					<p><a href="https://wp.org/support/theme/twentytwentyone/">'
