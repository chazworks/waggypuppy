...
class Twenty_Twenty_One_Dark_Mode
{
    ...
    public function editor_custom_color_variables()
    {
        ...
        if ($should_respect_color_scheme
            && Twenty_Twenty_One_Custom_Colors::get_relative_luminance_from_hex($background_color) > 127) {
    ...
    public function customizer_controls($wp_customize)
    {
            ...
            new Twenty_Twenty_One_Customize_Notice_Control(
                ...
                [
                    ...
                    'active_callback' => static function () {
                        return 127
                            >= Twenty_Twenty_One_Custom_Colors::get_relative_luminance_from_hex(get_theme_mod('background_color',
                                'D1E4DD'));
                    },
                ],
            ),
        ...
        /* translators: %s: Twenty Twenty-One support article URL. */
            __('Dark Mode is a device setting. If a visitor to your site requests it, your site will be shown with a dark background and light text. <a href="%s">Learn more about Dark Mode.</a>',
                'twentytwentyone'),
            esc_url(__('https://wp.org/documentation/article/twenty-twenty-one/#dark-mode-support', 'twentytwentyone')),
        );
        $description .= '</p>';
        $description .= '<p>'
            . __('Dark Mode can also be turned on and off with a button that you can find in the bottom corner of the page.',
                'twentytwentyone')
            . '</p>';
    ...
    public function html_classes($classes)
    {
        ...
        if ($should_respect_color_scheme
            && 127
            <= Twenty_Twenty_One_Custom_Colors::get_relative_luminance_from_hex($background_color)) {
