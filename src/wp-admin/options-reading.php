    ...
    [
        ...
        'content' => '<p>'
            ...
            /* translators: %s: Documentation URL. */
                ...
                __('https://developer.wp.org/advanced-administration/wordpress/feeds/'),
            )
            . '</p>'
            .
            '<p>'
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/settings-reading-screen/">Documentation on Reading Settings</a>')
    . '</p>'
    .
    '<p>'
...
<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        ?>
                            ...
                            if (get_option('wp_page_for_privacy_policy') === get_option('page_for_posts')
