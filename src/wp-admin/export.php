...
get_current_screen()->add_help_tab(
    [
        ...
        'content' => '<p>'
            ...
            .
            '<p>'
            . __('Once generated, your WXR file can be imported by another waggypuppy site or by another blogging platform able to access this format.')
            . '</p>',
    ],
);
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/tools-export-screen/">Documentation on Export</a>')
    . '</p>'
    .
    '<p>'
