...
$help .= '<li>'
    . __('<strong>View</strong> takes you to a public author archive which lists all the posts published by the user.')
    . '</li>';

if (current_user_can('edit_users')) {
    $help .= '<li>'
        . __('<strong>Send password reset</strong> sends the user an email with a link to set a new password.')
        . '</li>';
}
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/users-screen/">Documentation on Managing Users</a>')
    . '</p>'
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/roles-and-capabilities/">Descriptions of Roles and Capabilities</a>')
    . '</p>'
    .
    '<p>'
...
if (empty($_REQUEST)) {
    $referer = '<input type="hidden" name="wp_http_referer" value="'
            ...
            switch ($_GET['update']) {
                ...
                case 'resetpassword':
                    ...
                    if (1 === $reset_count) {
                        ...
                        /* translators: %s: Number of users. */
                        $message = _n('Password reset links sent to %s user.', 'Password reset links sent to %s users.',
                            $reset_count);
                    }
