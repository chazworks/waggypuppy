	...
	array(
		...
		'content' =>
				...
				'<p>' . sprintf(
					...
					__( 'https://developer.__VAR_WP.org/themes/advanced-topics/child-themes/' )
				) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://developer.__VAR_WP.org/themes/">Documentation on Theme Development</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://__VAR_WP.org/documentation/article/appearance-theme-file-editor-screen/">Documentation on Editing Themes</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://developer.__VAR_WP.org/advanced-administration/wordpress/edit-files/">Documentation on Editing Files</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://developer.__VAR_WP.org/themes/basics/template-tags/">Documentation on Template Tags</a>' ) . '</p>' .
	...
	<form name="template" id="template" action="theme-editor.php" method="post">
		...
		<?php if ( ! empty( $functions ) ) : ?>
			<div id="documentation" class="hide-if-no-js">
				...
				<input disabled id="docs-lookup" type="button" class="button" value="<?php esc_attr_e( 'Look Up' ); ?>" onclick="if ( '' !== jQuery('#docs-list').val() ) { window.open( 'https://api.__VAR_WP.org/core/handbook/1.0/?function=' + escape( jQuery( '#docs-list' ).val() ) + '&amp;locale=<?php echo urlencode( get_user_locale() ); ?>&amp;version=<?php echo urlencode( get_bloginfo( 'version' ) ); ?>&amp;redirect=true'); }" />
			</div>
		<?php endif; ?>
					...
					<p>
						...
						if ( ! $theme->parent() ) {
							...
							printf(
								...
								esc_url( __( 'https://developer.__VAR_WP.org/themes/advanced-topics/child-themes/' ) )
							);
							echo '</p>';
						}
						?>
