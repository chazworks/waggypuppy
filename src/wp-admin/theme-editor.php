...
get_current_screen()->set_help_sidebar(
    ...
    '<p>' . __('<a href="https://developer.wp.org/themes/">Documentation on Theme Development</a>') . '</p>' .
    '<p>' . __('<a href="https://wp.org/documentation/article/appearance-theme-file-editor-screen/">Documentation on Editing Themes</a>') . '</p>' .
    '<p>' . __('<a href="https://developer.wp.org/advanced-administration/wordpress/edit-files/">Documentation on Editing Files</a>') . '</p>' .
    '<p>' . __('<a href="https://developer.wp.org/themes/basics/template-tags/">Documentation on Template Tags</a>') . '</p>' .
