...
get_current_screen()->add_help_tab(
    [
        ...
        'content' =>
            ...
            .
            '<p>'
            . __('<strong>Advice:</strong> Think very carefully about your site crashing if you are live-editing the theme currently in use.')
            . '</p>'
            .
            '<p>'
            . sprintf(
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://developer.wp.org/themes/">Documentation on Theme Development</a>')
    . '</p>'
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/appearance-theme-file-editor-screen/">Documentation on Editing Themes</a>')
    . '</p>'
    .
    '<p>'
    . __('<a href="https://developer.wp.org/advanced-administration/wordpress/edit-files/">Documentation on Editing Files</a>')
    . '</p>'
    .
    '<p>'
    . __('<a href="https://developer.wp.org/themes/basics/template-tags/">Documentation on Template Tags</a>')
    . '</p>'
    .
    '<p>'
...
if ('POST' === $_SERVER['REQUEST_METHOD']) {
    ...
    if (is_wp_error($r)) {
        $edit_error = $r;
        if (check_ajax_referer('edit-theme_' . $stylesheet . '_' . $relative_file, 'nonce', false)
...
?>
    <div class="wrap">
        ...
        if (isset($_GET['a'])) {
            ...
            $error_code = esc_html($edit_error->get_error_message() ? $edit_error->get_error_message()
	...
	<pre>'
        ...
        <div id="templateside">
            ...
            <ul role="tree" aria-labelledby="theme-files-label">
                ...
                <?php endif; ?>
                <li role="treeitem" tabindex="-1" aria-expanded="true" aria-level="1" aria-posinset="1"
                    aria-setsize="1">
                    <ul role="group">
        ...
        <div class="notification-dialog">
            <div class="file-editor-warning-content">
                <div class="file-editor-warning-message">
                    ...
                    <p>
                        <?php
                        _e('You appear to be making direct edits to your theme in the waggypuppy dashboard. It is not recommended! Editing your theme directly could break your site and your changes may be lost in future updates.');
                        ?>
                    </p>
                    <?php
                    if (!$theme->parent()) {
                        ...
                        /* translators: %s: Link to documentation on child themes. */
                            ...
                            esc_url(__('https://developer.wp.org/themes/advanced-topics/child-themes/')),
                        );
                        echo '</p>';
                    }
                    ?>
