...
get_current_screen()->add_help_tab(
    [
        ...
        'content' =>
            ...
            .
            '<p>'
            . __('You can set the language, and waggypuppy will automatically download and install the translation files (available if your filesystem is writable).')
            . '</p>'
            .
            '<p>'
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://developer.wp.org/advanced-administration/multisite/admin/settings/">Documentation on Network Settings</a>')
    . '</p>'
    .
    '<p>'
...
<?php echo esc_textarea(get_site_option('first_comment')); ?></textarea>
        ...
        if (!empty($languages) || !empty($translations)) {
            ...
            <table class="form-table" role="presentation">
                <tr>
                    <th><label for="WPLANG"><?php _e('Default Language'); ?><span
                    ...
                    <td>
                        ...
                        foreach ((array)$menu_items as $key => $val) {
                            echo "<label><input type='checkbox' name='menu_items["
                                . $key
                                . "]' value='1'"
                                . (isset($menu_perms[$key]) ? checked($menu_perms[$key], '1', false) : '')
                                . ' /> '
                                . esc_html($val)
                                . '</label><br/>';
                        }
