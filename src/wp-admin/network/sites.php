...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://developer.__VAR_WP.org/advanced-administration/multisite/admin/#network-admin-sites-screen">Documentation on Site Management</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://__VAR_WP.org/support/forum/multisite/">Support forums</a>' ) . '</p>'
);
		...
		case 'allblogs':
			if ( isset( $_POST['action'] ) && isset( $_POST['allblogs'] ) ) {
				...
				if ( ! in_array( $doaction, array( 'delete', 'spam', 'notspam' ), true ) ) {
					...
					$redirect_to = apply_filters( 'handle_network_bulk_actions-' . get_current_screen()->id, $redirect_to, $doaction, $blogs, $id ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.UseUnderscores
