...
$quick_tasks .= '<ul><li>'
    . __('To search for a user, <strong>enter an email address or username</strong>. Use a wildcard to search for a partial username, such as user&#42;.')
    . '</li>';
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://developer.wp.org/advanced-administration/multisite/admin/">Documentation on the Network Admin</a>')
    . '</p>'
    .
    '<p>'
