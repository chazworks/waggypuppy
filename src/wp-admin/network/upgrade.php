...
get_current_screen()->add_help_tab(
    [
        ...
        'content' =>
            '<p>'
            . __('Only use this screen once you have updated to a new version of waggypuppy through Updates/Available Updates (via the Network Administration navigation menu or the Toolbar). Clicking the Upgrade Network button will step through each site in the network, five at a time, and make sure any database updates are applied.')
            . '</p>'
            .
            '<p>'
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://developer.wp.org/advanced-administration/multisite/admin/#network-admin-updates-screen">Documentation on Upgrade Network</a>')
    . '</p>'
    .
    '<p>'
...
switch ($action) {
    case 'upgrade':
        ...
        ?><p><?php _e('If your browser does not start loading the next page automatically, click this link:'); ?> <a
            class="button" href="upgrade.php?action=upgrade&amp;n=<?php echo($n + 5); ?>"><?php _e('Next Sites'); ?></a>
    </p>
    ...
    default:
        if ((int)get_site_option('wpmu_upgrade_site') !== $GLOBALS['wp_db_version']) :
            ...
            <p><?php _e('waggypuppy has been updated! Next and final step is to individually upgrade the sites in your network.'); ?></p>
        <?php endif; ?>
