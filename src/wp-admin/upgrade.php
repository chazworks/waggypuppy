...
<head>
    ...
    <title><?php _e('waggypuppy &rsaquo; Update'); ?></title>
    <?php wp_admin_css('install', true); ?>
</head>
<body class="wp-core-ui">
<p id="logo"><a href="<?php echo esc_url(__('https://wp.org/')); ?>"><?php _e('waggypuppy'); ?></a></p>

<?php if ((int) get_option('db_version') === $wp_db_version || ! is_blog_installed()) : ?>

<h1><?php _e('No Update Required'); ?></h1>
<p><?php _e('Your waggypuppy database is already up to date!'); ?></p>
...
<p><?php _e('waggypuppy has been updated! Next and final step is to update your database to the newest version.'); ?></p>
<p><?php _e('The database update process may take a little while, so please be patient.'); ?></p>
<p class="step"><a class="button button-large button-primary" href="upgrade.php?step=1&amp;backto=<?php echo $goback; ?>"><?php _e('Update waggypuppy Database'); ?></a></p>
            <?php
            break;
        case 1:
            wp_upgrade();
    ...
    <p><?php _e('Your waggypuppy database has been successfully updated!'); ?></p>
