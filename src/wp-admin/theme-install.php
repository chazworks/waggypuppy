...
$help_overview =
    ...
    .
    '<p>'
    . __('You can Search for themes by keyword, author, or tag, or can get more specific and search by criteria listed in the feature filter.')
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/appearance-themes-screen/#install-themes">Documentation on Adding New Themes</a>')
    . '</p>'
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/block-themes/">Documentation on Block Themes</a>')
    . '</p>'
    .
    '<p>'
    ...
    <div class="wrap">
        ...
        <div class="wp-filter hide-if-no-js">
            ...
            <div class="favorites-form">
                ...
                ?>
                <p class="install-help"><?php _e('If you have marked themes as favorites on wp.org, you can browse them here.'); ?></p>

                <p class="favorites-username">
                    <label for="wporg-username-input"><?php _e('Your wp.org username:'); ?></label>
    ...
    <script id="tmpl-theme" type="text/template">
        ...
        <div class="theme-id-container">
            ...
            <div class="theme-actions">
                ...
                ?>
                <a class="button button-primary theme-install" data-name="{{ data.name }}" data-slug="{{ data.id }}"
                ...
                ?>
                <a class="button button-primary disabled" data-name="{{ data.name }}"
    ...
    <script id="tmpl-theme-preview" type="text/template">
        <div class="wp-full-overlay-sidebar">
            <div class="wp-full-overlay-header">
                ...
                <# } else { #>
                <# if ( data.compatible_wp && data.compatible_php ) { #>
                <a href="{{ data.install_url }}" class="button button-primary theme-install" data-name="{{ data.name }}"
