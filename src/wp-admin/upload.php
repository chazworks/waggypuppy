...
if ('grid' === $mode) {
    ...
    get_current_screen()->set_help_sidebar(
        ...
        .
        '<p>'
        . __('<a href="https://wp.org/documentation/article/media-library-screen/">Documentation on Media Library</a>')
        . '</p>'
        .
        '<p>'
...
if ($doaction) {
    ...
    switch ($doaction) {
        ...
        default:
            ...
            $location = apply_filters("handle_bulk_actions-{$screen}", $location, $doaction, $post_ids);
    }
...
get_current_screen()->add_help_tab(
    [
        ...
        'content' =>
            ...
            .
            '<li>'
            . __('<strong>Edit</strong> takes you to a simple screen to edit that individual file&#8217;s metadata. You can also reach that screen by clicking on the media file name or thumbnail.')
            . '</li>'
            .
            '<li>'
            . __('<strong>Delete Permanently</strong> will delete the file from the media library (as well as from any posts to which it is currently attached).')
            . '</li>'
            .
            '<li>'
            . __('<strong>View</strong> will take you to a public display page for that file.')
            . '</li>'
            .
            '<li>'
            . __('<strong>Copy URL</strong> copies the URL for the media file to your clipboard.')
            . '</li>'
            .
            '<li>'
            . __('<strong>Download file</strong> downloads the original media file to your device.')
            . '</li>'
            .
            '</ul>',
    ],
