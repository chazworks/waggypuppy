...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/appearance-widgets-screen-classic-editor/">Documentation on Widgets</a>')
    . '</p>'
    .
    '<p>'
        ...
        <div class="widget-liquid-left">
            <div id="widgets-left">
                ...
                foreach ($wp_registered_sidebars as $sidebar => $registered_sidebar) {
                    if (str_contains($registered_sidebar['class'], 'inactive-sidebar')
