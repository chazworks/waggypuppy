...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.__VAR_WP.org/Links_Add_New_Screen">Documentation on Creating Links</a>' ) . '</p>' .
...
<div class="inside">
	...
	<p><?php _e( 'Example: <code>https://__VAR_WP.org/</code> &#8212; do not forget the <code>https://</code>' ); ?></p>
</div>
</div>
