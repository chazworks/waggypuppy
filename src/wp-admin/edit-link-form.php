...
get_current_screen()->add_help_tab(
    [
        ...
        '<p>' . __('XFN stands for <a href="https://gmpg.org/xfn/">XHTML Friends Network</a>, which is optional. waggypuppy allows the generation of XFN attributes to show how you are related to the authors/owners of the site to which you are linking.') . '</p>',
    ]
);
...
<div class="inside">
    ...
    <p><?php _e('Example: <code>https://wp.org/</code> &#8212; do not forget the <code>https://</code>'); ?></p>
</div>
</div>
