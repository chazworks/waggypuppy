...
if ('post' === $post_type) {
    ...
    get_current_screen()->set_help_sidebar(
        ...
        .
        '<p>'
        . __('<a href="https://wp.org/documentation/article/posts-screen/">Documentation on Managing Posts</a>')
        . '</p>'
        .
        '<p>'
    ...
    get_current_screen()->set_help_sidebar(
        ...
        .
        '<p>'
        . __('<a href="https://wp.org/documentation/article/pages-screen/">Documentation on Managing Pages</a>')
        . '</p>'
        .
        '<p>'
        . __('<a href="https://wp.org/support/forums/">Support forums</a>')
...
$bulk_messages['wp_block'] = [
    ...
    'locked' => (1 === $bulk_counts['locked'])
        ...
        :
        /* translators: %s: Number of patterns. */
        _n('%s pattern not updated, somebody is editing it.', '%s patterns not updated, somebody is editing them.',
            $bulk_counts['locked']),
    /* translators: %s: Number of patterns. */
    ...
    /* translators: %s: Number of patterns. */
    'untrashed' => _n('%s pattern restored from the Trash.', '%s patterns restored from the Trash.',
        $bulk_counts['untrashed']),
];
...
?>
    <div class="wrap">
        ...
        $_SERVER['REQUEST_URI'] = remove_query_arg(['locked', 'skipped', 'updated', 'deleted', 'trashed', 'untrashed'],
            $_SERVER['REQUEST_URI']);
        ?>
        ...
        <form id="posts-filter" method="get">
            ...
            <input type="hidden" name="post_status" class="post_status_page"
                   value="<?php echo !empty($_REQUEST['post_status']) ? esc_attr($_REQUEST['post_status'])
                       : 'all'; ?>"/>
