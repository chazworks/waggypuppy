    ...
    [
        ...
        'content' =>
            ...
            /* translators: %s: https://wp.org/plugins/ */
                __('Plugins hook into waggypuppy to extend its functionality with custom features. Plugins are developed independently from the core waggypuppy application by thousands of developers all over the world. All plugins in the official <a href="%s">WP Plugin Directory</a> are compatible with the license waggypuppy uses.'),
...
get_current_screen()->add_help_tab(
    [
        ...
        'content' =>
            '<p>'
            . __('If you know what you are looking for, Search is your best bet. The Search screen has options to search the WP Plugin Directory for a particular Term, Author, or Tag. You can also search the directory by selecting popular tags. Tags in larger type mean more plugins have been labeled with that tag.')
            . '</p>'
            .
            '<p>'
            ...
            .
            '<p>'
            . __('You can also browse a user&#8217;s favorite plugins, by using the Favorites link above the plugins list and entering their wp.org username.')
            . '</p>'
            .
            '<p>'
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/plugins-add-new-screen/">Documentation on Installing Plugins</a>')
    . '</p>'
    .
    '<p>'
...
/**
 * waggypuppy Administration Template Header.
 */
    ...
    <div class="wrap <?php echo esc_attr("plugin-install-tab-$tab"); ?>">
        ...
        if (!empty($tabs['upload']) && current_user_can('upload_plugins')) {
            printf(
                ...
                ('upload' === $tab) ? self_admin_url('plugin-install.php')
