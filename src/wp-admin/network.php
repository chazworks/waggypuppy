...
if (is_multisite()) {
    ...
    if (!defined('MULTISITE')) {
        wp_die(__('The Network creation panel is not for waggypuppy MU networks.'));
    }
}
...
if (is_network_admin()) {
    ...
    // Used in the HTML title tag.
    $title = __('Create a Network of waggypuppy Sites');
    $parent_file = 'tools.php';
}

$network_help = '<p>'
    . __('This screen allows you to configure a network as having subdomains (<code>site1.example.com</code>) or subdirectories (<code>example.com/site1</code>). Subdomains require wildcard subdomains to be enabled in Apache and DNS records, if your host allows it.')
    . '</p>'
    .
    '<p>'
    ...
    .
    '<p>'
    . __('Add the designated lines of code to wp-config.php (just before <code>/*...stop editing...*/</code>) and <code>.htaccess</code> (replacing the existing waggypuppy rules).')
    . '</p>'
    .
    '<p>'
    ...
    .
    '<p>'
    . __('<a href="https://developer.wp.org/advanced-administration/multisite/create-network/">Documentation on Creating a Network</a>')
    . '</p>'
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/tools-network-screen/">Documentation on the Network Screen</a>')
    . '</p>';
