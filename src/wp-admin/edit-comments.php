...
if ($doaction) {
    ...
    if (! in_array($doaction, ['approve', 'unapprove', 'spam', 'unspam', 'trash', 'delete'], true)) {
        ...
        $redirect_to = apply_filters("handle_bulk_actions-{$screen}", $redirect_to, $doaction, $comment_ids); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores
    }
...
get_current_screen()->set_help_sidebar(
    ...
    '<p>' . __('<a href="https://wp.org/documentation/article/comments-screen/">Documentation on Comments</a>') . '</p>' .
    '<p>' . __('<a href="https://wp.org/documentation/article/understand-comment-spam/">Documentation on Comment Spam</a>') . '</p>' .
    '<p>' . __('<a href="https://wp.org/documentation/article/keyboard-shortcuts-classic-editor/#keyboard-shortcuts-for-comments">Documentation on Keyboard Shortcuts</a>') . '</p>' .
