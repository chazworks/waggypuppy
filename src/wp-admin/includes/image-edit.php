                        ...
                        <div id="imgedit-rotate-menu" class="imgedit-popup-menu">
                            ...
                            if (wp_image_editor_supports(
                                ...
                                <button type="button" class="imgedit-rleft button"
                                        onkeydown="imageEdit.browsePopup(event, this)"
                                ...
                                <button type="button" class="imgedit-rfull button"
                                        onkeydown="imageEdit.browsePopup(event, this)"
                                ...
                                $note_no_rotate = '<p class="note-no-rotate"><em>'
                                        ...
                                        <fieldset class="imgedit-scale-controls">
                                            ...
                                            <div class="nowrap">
                                                ...
                                                <input type="number" step="1" min="0"
                                                       ...
                                                       value="<?php echo isset($meta['width']) ? $meta['width']
                                                           : 0; ?>"/>
                                                ...
                                                <input type="number" step="1" min="0"
                                                       ...
                                                       value="<?php echo isset($meta['height']) ? $meta['height']
                                                           : 0; ?>"/>
                                ...
                                <div class="imgedit-group-top">
                                    <h2>
                                        <button type="button" onclick="imageEdit.toggleHelp(this);" class="button-link"
                                                ...
                                                class="dashicons dashicons-arrow-down imgedit-help-toggle"></span>
                                        </button>
                                    </h2>
        ...
        switch ($operation->type) {
            ...
            case 'crop':
                ...
                if ($image instanceof WP_Image_Editor) {
                    ...
                    $scale = isset($sel->r) ? $sel->r
                        : 1 / _image_get_preview_ratio($w, $h); // Discard preview scaling.
                    $image->crop((int)($sel->x * $scale), (int)($sel->y * $scale), (int)($sel->w * $scale),
                        (int)($sel->h * $scale));
                } else {
                    $scale = isset($sel->r) ? $sel->r
                        : 1 / _image_get_preview_ratio(imagesx($image), imagesy($image)); // Discard preview scaling.
