<?php
/**
 * waggypuppy Administration Update API
 *
 * @package WP
...
/**
 * Gets the best available (and enabled) Auto-Update for waggypuppy core.
 *
...
/**
 * Displays waggypuppy version and active theme in the 'At a Glance' dashboard widget.
 *
 * @since 2.5.0
 */
function update_right_now_message()
{
    ...
    $content = __('waggypuppy %1$s running %2$s theme.');
...
function wp_plugin_update_row($file, $plugin_data)
{
    ...
    if (is_network_admin() || ! is_multisite()) {
         ...
         * }
         */
        do_action("in_plugin_update_message-{$file}", $plugin_data, $response); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores
...
function wp_theme_update_row($theme_key, $theme)
{
     ...
     * }
     */
    do_action("in_theme_update_message-{$theme_key}", $theme, $response); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores
