<?php
/**
 * waggypuppy Plugin Install Administration API
 *
 * @package WP
 ...
 *         {@link https://developer.wp.org/reference/functions/plugins_api/ function reference article}
    ...
    switch (current_filter()) {
        case 'install_plugins_beta':
            ...
            /* translators: %s: URL to "Features as Plugins" page. */
                '<p>'
                . __('You are using a development version of waggypuppy. These feature plugins are also under development. <a href="%s">Learn more</a>.')
                . '</p>',
        ...
        case 'install_plugins_featured':
            ...
            /* translators: %s: https://wp.org/plugins/ */
                '<p>'
                . __('Plugins extend and expand the functionality of waggypuppy. You may install plugins in the <a href="%s">waggypuppy Plugin Directory</a> right from here, or upload a plugin in .zip format by clicking the button at the top of this page.')
                . '</p>',
...
<div id="<?php echo $_tab; ?>-content" class='<?php echo $_with_banner; ?>'>
    <div class="fyi">
        <ul>
            ...
            if (!empty($api->slug) && empty($api->external)) { ?>
                <li><a target="_blank" href="<?php echo esc_url(__('https://wp.org/plugins/')
                        . $api->slug); ?>/"><?php _e('wp.org Plugin Page &#187;'); ?></a></li>
            <?php }
                ...
                <div class="counter-container">
                        <span class="counter-label">
                            ...
                            printf(
                                ...
                                "https://wp.org/support/plugin/{$api->slug}/reviews/?filter={$key}",
                                $aria_label,
    ...
    foreach ((array)$api->sections as $section_name => $content) {
        $content = links_add_base_url($content, 'https://wp.org/plugins/' . $api->slug . '/');
