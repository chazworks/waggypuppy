    ...
    <div class="main">
        <ul>
            ...
            if ($num_comm && ($num_comm->approved || $num_comm->moderated)) {
                ...
                /* translators: %s: Number of comments. */
                $text = sprintf(_n('%s Comment in moderation', '%s Comments in moderation', $num_comm->moderated),
...
function wp_print_community_events_markup()
{
    ...
    $community_events_notice .= '<p class="community-events-error-occurred" aria-hidden="true">'
...
function wp_dashboard_browser_nag()
{
    ...
    if ($response) {
        ...
        $notice .= '<p class="hide-if-no-js"><a href="" class="dismiss" aria-label="'
