...
function _wp_handle_upload(&$file, $overrides, $time, $action)
{
    ...
    $test_uploaded_file = 'wp_handle_upload' === $action ? is_uploaded_file($file['tmp_name'])
            ...
            return new WP_Error(
                ...
                [
                    ...
                    'sodium' => defined('SODIUM_LIBRARY_VERSION')
                        ...
                        : (defined('ParagonIE_Sodium_Compat::VERSION_STRING') ? ParagonIE_Sodium_Compat::VERSION_STRING
                            : false),
    ...
    <form action="<?php echo esc_url($form_post); ?>" method="post">
        <div id="request-filesystem-credentials-form" class="request-filesystem-credentials-form">
            ...
            <p id="request-filesystem-credentials-desc">
                ...
                _e('To perform the requested action, waggypuppy needs to access your web server.');
                echo ' ';
            ...
            <label for="hostname">
                ...
                <input name="hostname" type="text" id="hostname" aria-describedby="request-filesystem-credentials-desc"
                       class="code" placeholder="<?php esc_attr_e('example: www.wp.org'); ?>"
...
function wp_opcache_invalidate($filepath, $force = false)
{
     ...
     *
     * @param bool $will_invalidate Whether waggypuppy will invalidate `$filepath`. Default true.
