...
class Walker_Nav_Menu_Checklist extends Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $data_object, $depth = 0, $args = null, $current_object_id = 0)
    {
        ...
        $possible_object_id = isset($menu_item->post_type) && 'nav_menu_item' === $menu_item->post_type
            ? $menu_item->object_id : $_nav_menu_placeholder;
        ...
        $output .= '<input type="hidden" class="menu-item-target" name="menu-item['
            ...
            . '" />';
        $output .= '<input type="hidden" class="menu-item-attr-title" name="menu-item['
            . $possible_object_id
