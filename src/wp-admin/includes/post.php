...
function bulk_edit_posts($post_data = null)
{
    ...
    foreach ($post_ids as $post_id) {
        ...
        if (isset($new_cats) && in_array('category', $tax_names, true)) {
            ...
            if (isset($post_data['indeterminate_post_category'])
...
function _fix_attachment_links($post)
{
    ...
    if (!strpos($content, '?attachment_id=')
...
function get_sample_permalink_html($post, $new_title = null, $new_slug = null)
{
    ...
    if (!str_contains($permalink, '%postname%') && !str_contains($permalink, '%pagename%')) {
        ...
        if (false !== $view_link) {
            ...
            $return .= '<a id="sample-permalink" href="'
                . esc_url($view_link)
                . '"'
                . $preview_target
                . '>'
        ...
        if (!get_option('permalink_structure') && current_user_can('manage_options')
            ...
            $return .= '<span id="change-permalinks"><a href="options-permalink.php" class="button button-small">'
        ...
        $return = '<strong>' . __('Permalink:') . "</strong>\n";
        $return .= '<span id="sample-permalink"><a href="'
            . esc_url($view_link)
            . '"'
            . $preview_target
            . '>'
        ...
        $return .= '<span id="edit-slug-buttons"><button type="button" class="edit-slug button button-small hide-if-no-js" aria-label="'
            . __('Edit permalink')
            . '">'
            . __('Edit')
            . "</button></span>\n";
...
function post_preview()
{
    ...
    if ($is_autosave && $saved_post_id) {
        ...
        if (isset($_POST['post_format'])) {
            $query_args['post_format'] = empty($_POST['post_format']) ? 'standard'
