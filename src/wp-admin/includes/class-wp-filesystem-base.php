...
/**
 * Base waggypuppy Filesystem class which Filesystem implementations extend.
 *
 * @since 2.5.0
 */
...
class WP_Filesystem_Base
{
    ...
    public function search_for_folder($folder, $base = '.', $loop = false)
    {
        ...
        foreach ($folder_parts as $index => $key) {
             ...
             * for it. If it can't find waggypuppy down that route, it'll continue onto the next
