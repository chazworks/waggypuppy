...
class WP_Themes_List_Table extends WP_List_Table
{
        ...
        if (is_multisite()) {
            ...
            if (current_user_can('install_themes')) {
                ...
                /* translators: %s: URL to Add Themes screen. */
                    __('You only have one theme installed right now. Live a little! You can choose from over 1,000 free themes in the WP Theme Directory at any time: just click on the <a href="%s">Install Themes</a> tab above.'),
    ...
    public function display_rows()
    {
        ...
        foreach ($themes as $theme) :
            ...
            <div class="available-theme">
                ...
                $activate_link = wp_nonce_url('themes.php?action=activate&amp;template='
                    . urlencode($template)
                    . '&amp;stylesheet='
                    . urlencode($stylesheet), 'switch-theme_' . $stylesheet);
                ...
                $delete_action = isset($actions['delete']) ? '<div class="delete-theme">'
                    . $actions['delete']
                    . '</div>' : '';
                ...
                <div class="themedetaildiv hide-if-js">
                    ...
                    if ($theme->parent()) {
                        ...
                        /* translators: 1: Link to documentation on child themes, 2: Name of parent theme. */
                            ' <p class="howto">'
                            . __('This <a href="%1$s">child theme</a> requires its parent theme, %2$s.')
                            . '</p>',
    ...
    public function _js_vars($extra_args = [])
    {
        ...
        $args = [
            ...
            'total_pages' => !empty($this->_pagination_args['total_pages']) ? $this->_pagination_args['total_pages']
                : 1,
        ];
