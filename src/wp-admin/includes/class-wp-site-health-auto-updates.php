...
class WP_Site_Health_Auto_Updates
{
    ...
    public function test_if_failed_update()
    {
        ...
        if (!empty($failed['critical'])) {
            ...
            $description .= ' '
                . __("When you've been able to update using the \"Update now\" button on Dashboard > Updates, this error will be cleared for future update attempts.");
            $description .= ' ' . sprintf(
    ...
    public function test_check_wp_filesystem_method()
    {
        ...
        if (!$success) {
            ...
            $description .= ' '
                . __('(Your site is performing updates over FTP due to file ownership. Talk to your hosting company.)');
    ...
    public function test_all_files_writable()
    {
        ...
        if ($unwritable_files) {
            ...
            return [
                'description' => __('Some files are not writable by waggypuppy:') . ' <ul><li>' . implode('</li><li>',
