...
class Custom_Image_Header
{
    ...
    public function help()
    {
        ...
        get_current_screen()->add_help_tab(
            [
                ...
                'content' =>
                    ...
                    .
                    '<p>'
                    . __('If your theme has more than one default header image, or you have uploaded more than one custom header image, you have the option of having waggypuppy display a randomly different image on each page of your site. Click the &#8220;Random&#8221; radio button next to the Uploaded Images or Default Images section to enable this feature.')
                    . '</p>'
                    .
                    '<p>'
        ...
        get_current_screen()->set_help_sidebar(
            ...
            .
            '<p>'
            . __('<a href="https://codex.wp.org/Appearance_Header_Screen">Documentation on Custom Header</a>')
            . '</p>'
            .
            '<p>'
                            ...
                            <p><?php _e('You can select an image to be shown at the top of your site by uploading from your computer or choosing from your media library. After selecting an image you will be able to crop it.'); ?>
                                ...
                                if (!current_theme_supports('custom-header', 'flex-height')
                                    ...
                                    /* translators: 1: Image width in pixels, 2: Image height in pixels. */
                                        __('Images of exactly <strong>%1$d &times; %2$d pixels</strong> will be used as-is.')
                                        . '<br />',
                        ...
                        <tr class="displaying-header-text">
                            ...
                            <td>
                                <p>
                                    ...
                                    $default_color_attr = $default_color ? ' data-default-color="'
                                        . esc_attr($default_color)
                                        . '"' : '';

                                    $header_textcolor = display_header_text() ? get_header_textcolor()
