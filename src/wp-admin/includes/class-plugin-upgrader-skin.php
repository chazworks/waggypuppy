...
/**
 * Plugin Upgrader Skin for waggypuppy Plugin Upgrades.
 *
 * @since 2.8.0
...
class Plugin_Upgrader_Skin extends WP_Upgrader_Skin
{
    ...
    public function after()
    {
        ...
        if (!empty($this->plugin) && !is_wp_error($this->result) && $this->plugin_active) {
            ...
            printf(
                ...
                wp_nonce_url('update.php?action=activate-plugin&networkwide='
                    ...
                    . '&plugin='
                    . urlencode($this->plugin), 'activate-plugin_' . $this->plugin),
            );
        }
        ...
        if ($this->plugin_active || !$this->result || is_wp_error($this->result)
