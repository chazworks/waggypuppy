...
class WP_Posts_List_Table extends WP_List_Table
{
    ...
    public function column_comments($post)
    {
        ...
        <div class="post-com-count-wrapper">
            <?php
            $pending_comments = isset($this->comment_pending_count[$post->ID]) ? $this->comment_pending_count[$post->ID]
                : 0;
                            ...
                            <div class="inline-edit-wrapper" role="region"
                                ...
                                <fieldset class="inline-edit-col-left">
                                    <legend class="inline-edit-legend"
                                            id="<?php echo $bulk ? 'bulk' : 'quick'; ?>-edit-legend"><?php echo $bulk
                                            ? __('Bulk Edit') : __('Quick Edit'); ?></legend>
                                            ...
                                            if (current_user_can($post_type_object->cap->edit_others_posts)) {
                                                ...
                                                if (wp_is_large_user_count()) {
                                                    ...
                                                    if ($authors) {
                                                        ...
                                                        $authors_dropdown .= '<span class="title">'
                                                            . __('Author')
                                                            . '</span>';
                                                    ...
                                                    <?php if (post_type_supports($screen->post_type, 'comments')) : ?>
                                                        ...
                                                        <label class="alignleft">
                                                            ...
                                                            <select name="comment_status">
                                                                ...
                                                                <option
                                                                    value="closed"><?php _e('Do not allow'); ?></option>
                                                            </select>
                                                        </label>
                                                ...
                                                <div class="inline-edit-group wp-clearfix">
                                                    ...
                                                    <?php if (post_type_supports($screen->post_type, 'trackbacks')) : ?>
                                                        ...
                                                        <label class="alignleft">
                                                            ...
                                                            <span
                                                                class="checkbox-title"><?php _e('Allow Pings'); ?></span>
                                                        </label>
