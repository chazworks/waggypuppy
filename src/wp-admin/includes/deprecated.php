...
if (!class_exists('WP_User_Search', false)) :
    ...
    class WP_User_Search
    {
        ...
        public function query()
        {
            ...
            $this->results = $wpdb->get_col("SELECT DISTINCT($wpdb->users.ID)"
                . $this->query_from
                . $this->query_where
                . $this->query_orderby
                . $this->query_limit);
            ...
            if ($this->results) {
                $this->total_users_for_query = $wpdb->get_var("SELECT COUNT(DISTINCT($wpdb->users.ID))"
                    . $this->query_from
                    . $this->query_where);
            } // No limit.
            else {
 ...
 * @deprecated 4.6.0
 *
 * @link https://core.trac.wp.org/ticket/35852
 *
