...
if (false) {
    ...
    <p>wp requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned
        off.</p>
    </body>
    </html>
    <?php
...
<head>
    ...
    <title><?php _e('waggypuppy &rsaquo; Installation'); ?></title>
...
function display_setup_form($error = null)
{
    ...
    <form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
        <table class="form-table" role="presentation">
            ...
            <?php if (!$user_table) : ?>
                    ...
                    <td>
                        <div class="wp-pwd">
                            <?php $initial_password = isset($_POST['admin_password'])
                                ? stripslashes($_POST['admin_password']) : wp_generate_password(18); ?>
                ...
                <tr class="form-field form-required user-pass2-wrap hide-if-js">
                    ...
                    <td>
                        <input type="password" name="admin_password2" id="pass2" autocomplete="new-password"
                               spellcheck="false"/>
                    </td>
                </tr>
                <tr class="pw-weak">
            ...
            <tr>
                ...
                <td><input name="admin_email" type="email" id="admin_email" size="25"
                           aria-describedby="admin-email-desc" value="<?php echo esc_attr($admin_email); ?>"/>
                    <p id="admin-email-desc"><?php _e('Double-check your email address before continuing.'); ?></p></td>
            </tr>
            <tr>
                <th scope="row"><?php has_action('blog_privacy_selector') ? _e('Site visibility')
                    ...
                    <fieldset>
                        ...
                        if (has_action('blog_privacy_selector')) {
                            ...
                            <label for="blog_public"><input name="blog_public" type="checkbox" id="blog_public"
                                                            aria-describedby="privacy-desc" value="0" <?php checked(0,
                                    $blog_public); ?> />
        ...
        <p class="step"><?php submit_button(__('Install waggypuppy'), 'large', 'Submit', false,
                ['id' => 'submit']); ?></p>
...
if (is_blog_installed()) {
    ...
    die(
        ...
        .
        '<p>'
        . __('You appear to have already installed waggypuppy. To reinstall please clear your old database tables first.')
        . '</p>'
        .
        '<p class="step"><a href="'
...
if (defined('DO_NOT_UPGRADE_GLOBAL_TABLES')) {
    ...
    die(
        ...
        /* translators: %s: DO_NOT_UPGRADE_GLOBAL_TABLES */
            __('The constant %s cannot be defined when installing waggypuppy.'),
...
switch ($step) {
    ...
    case 1: // Step 1, direct link or from language chooser.
        ...
        ?>
        <h1><?php _ex('Welcome', 'Howdy'); ?></h1>
        <p><?php _e('Welcome to the famous five-minute waggypuppy installation process! Just fill in the information below and you&#8217;ll be on your way to using the most extendable and powerful personal publishing platform in the world.'); ?></p>
    ...
    case 2:
        ...
        if (false === $error) {
            ...
            <p><?php _e('waggypuppy has been installed. Thank you, and enjoy!'); ?></p>
