...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://developer.__VAR_WP.org/advanced-administration/plugins/editor-screen/">Documentation on Editing Plugins</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://developer.__VAR_WP.org/plugins/">Documentation on Writing Plugins</a>' ) . '</p>' .
