...
if (empty($plugin)) {
    if ($file) {
        ...
        foreach (array_keys($plugins) as $plugin_candidate) {
            if ($plugin_candidate === $file
                || ('.' !== $file_dirname
                    && dirname($plugin_candidate)
                    === $file_dirname)) {
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://developer.wp.org/advanced-administration/plugins/editor-screen/">Documentation on Editing Plugins</a>')
    . '</p>'
    .
    '<p>'
    . __('<a href="https://developer.wp.org/plugins/">Documentation on Writing Plugins</a>')
    . '</p>'
    .
    '<p>'
...
?>
    <div class="wrap">
        ...
        elseif (is_wp_error($edit_error)) :
            $error = esc_html($edit_error->get_error_message() ? $edit_error->get_error_message()
        ...
        <div class="notification-dialog">
            <div class="file-editor-warning-content">
                <div class="file-editor-warning-message">
                    ...
                    <p><?php _e('You appear to be making direct edits to your plugin in the waggypuppy dashboard. Editing plugins directly is not recommended as it may introduce incompatibilities that break your site and your changes may be lost in future updates.'); ?></p>
