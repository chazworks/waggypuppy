...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://__VAR_WP.org/documentation/article/tools-import-screen/">Documentation on Import</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://__VAR_WP.org/support/forums">Support</a>' ) . '</p>'
);
