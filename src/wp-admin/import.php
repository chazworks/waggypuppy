...
get_current_screen()->add_help_tab(
    [
        ...
        'content' => '<p>'
            ...
            .
            '<p>'
            . __('In previous versions of WP, all importers were built-in. They have been turned into plugins since most people only use them once or infrequently.')
            . '</p>',
    ],
);
...
get_current_screen()->set_help_sidebar(
    ...
    .
    '<p>'
    . __('<a href="https://wp.org/documentation/article/tools-import-screen/">Documentation on Import</a>')
    . '</p>'
    .
    '<p>'
    . __('<a href="https://wp.org/support/forums">Support</a>')
    . '</p>',
);
...
?>
    ...
    <div class="wrap">
        ...
        ?>
        <p><?php _e('If you have posts or comments in another system, waggypuppy can import those into this site. To get started, choose a system to import from below:'); ?></p>
