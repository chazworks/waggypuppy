	...
	var modern = ( function ( domGlobals ) {
		...
		var addContextualToolbars = function ( editor ) {
			...
			var reposition = function ( match, shouldShow ) {
				...
				if (
					DOM.getStyle( match.element, 'display', true ) !== 'inline'
				) {
		...
		var Selector = global$a.extend( {
			init: function ( selector ) {
				...
				function compile( selector, filters, direct ) {
					...
					add(
						compileAttrFilter( parts[ 4 ], parts[ 5 ], parts[ 6 ] )
					);
				...
				msgBox: function ( settings ) {
					...
					switch ( settings.buttons ) {
						...
						case MessageBox.YES_NO_CANCEL:
							...
							if (
								settings.buttons === MessageBox.YES_NO_CANCEL
							) {
		...
		var getLevel = function ( elm ) {
			return isHeader( elm )
				? parseInt( elm.nodeName.substr( 1 ), 10 )
				: 0;
		};
				...
				function handleDrag( minValue, maxValue, handleEl ) {
					...
					self._dragHelper = new DragHelper( self._id, {
						...
						drag: function ( e ) {
							...
							self.tooltip()
								.text(
									'' + self.settings.previewFilter( value )
								)
								.show()
