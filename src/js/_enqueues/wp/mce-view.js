		...
		/** @lends wp.mce.View.prototype */ {
			...
			getMarkers: function ( callback ) {
				this.getEditors( function ( editor ) {
					...
					$( editor.getBody() )
						.find(
							'[data-wpview-marker="' + this.encodedText + '"]'
						)
						.each( function () {
			 ...
			 * @param {string} dashicon A dashicon ID. Optional. {@link https://developer.wp.org/resource/dashicons/}
			 */
...
/*
 * The waggypuppy core TinyMCE views.
...
( function ( window, views, media, $ ) {
	...
	embed = _.extend( {}, av, {
		...
		edit: function ( text, update ) {
			...
			frame
				.state( 'embed' )
				.props.on( 'change:url', function ( model, url ) {
