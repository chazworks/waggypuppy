...
wp.customize.navMenusPreview = wp.customize.MenusCustomizerPreview =
	( function ( $, _, wp, api ) {
		'use strict';
		...
		if ( api.selectiveRefresh ) {
				...
				/** @lends wp.customize.navMenusPreview.NavMenuInstancePartial.prototype */ {
					...
					isRelatedSetting: function ( setting, newValue, oldValue ) {
						...
						return (
							...
							( isNavMenuItemSetting &&
								( ( newValue &&
									newValue.nav_menu_term_id === navMenuId ) ||
									( oldValue &&
			 ...
			 */
			self.handleUnplacedNavMenuInstances = function (
				navMenuInstanceArgs
			) {
				...
				if (
					_.findWhere( unplacedNavMenuInstances, navMenuInstanceArgs )
				) {
