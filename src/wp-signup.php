...
if (is_array(get_site_option('illegal_names')) && isset($_GET['new'])
    ...
    <div id="signup-content" class="widecolumn">
        <div class="mu_register wp-signup-container" role="main">
            ...
            function signup_another_blog($blogname = '', $blog_title = '', $errors = '')
            {
                ...
                echo '<h2>'
                    . sprintf(__('Get <em>another</em> %s site in seconds'), get_network()->site_name)
                    . '</h2>';
            ...
            function validate_another_blog_signup()
            {
                 ...
                 * @since MU (3.0.0)
                 */
                $meta_defaults = apply_filters_deprecated('signup_create_blog_meta', [$blog_meta_defaults], '3.0.0',
                    'add_signup_meta');
                ...
                $blog_id = wpmu_create_blog($domain, $path, $blog_title, $current_user->ID, $meta,
                ...
                <form id="setupform" method="post" action="wp-signup.php" novalidate="novalidate">
                    ...
                    <?php else : ?>
                        <fieldset class="signup-options">
                            ...
                            <p class="wp-signup-radio-buttons">
                    <span class="wp-signup-radio-button">
                        <input id="signupblog" type="radio" name="signup_for" value="blog" <?php checked($signup_for,
                            'blog'); ?> />
                        <label class="checkbox" for="signupblog"><?php _e('Gimme a site!'); ?></label>
                    </span>
                                <span class="wp-signup-radio-button">
                        <input id="signupuser" type="radio" name="signup_for" value="user" <?php checked($signup_for,
                            'user'); ?> />
            ...
            function confirm_user_signup($user_name, $user_email)
            {
                ...
                <p>
                    ...
                    printf(__('Check your inbox at %s and click on the given link.'),
            ...
            $newblogname = isset($_GET['new']) ? strtolower(preg_replace('/^-|-$|[^-a-zA-Z0-9]/', '', $_GET['new']))
                : null;
