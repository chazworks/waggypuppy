...
switch ($action) {
    ...
    case 'retrievepassword':
        ...
        <p id="nav">
            ...
            if (get_option('users_can_register')) {
                $registration_url = sprintf('<a class="wp-login-register" href="%s">%s</a>',
                    esc_url(wp_registration_url()), __('Register'));
    ...
    case 'register':
        ...
        <form name="registerform" id="registerform"
            ...
            <p>
                ...
                <input type="email" name="user_email" id="user_email" class="input"
                       value="<?php echo esc_attr($user_email); ?>" size="25" autocomplete="email" required="required"/>
            </p>
            <?php
        ...
        <p id="nav">
            ...
            $html_link = sprintf('<a class="wp-login-lost-password" href="%s">%s</a>', esc_url(wp_lostpassword_url()),
    ...
    default:
        ...
        $requested_redirect_to = isset($_REQUEST['redirect_to']) && is_string($_REQUEST['redirect_to'])
        ...
        if ($interim_login) {
            ...
            if (isset($_GET['loggedout']) && $_GET['loggedout']) {
                ...
                $errors->add('updated',
                    __('<strong>You have successfully updated waggypuppy!</strong> Please log back in to see what&#8217;s new.'),
                    'message');
        ...
        if (isset($_POST['log'])) {
            $user_login = ('incorrect_password' === $errors->get_error_code()
                || 'empty_password'
                === $errors->get_error_code()) ? wp_unslash($_POST['log']) : '';
        }
        ...
        if (!$interim_login) {
            ...
            <p id="nav">
                ...
                $html_link = sprintf('<a class="wp-login-lost-password" href="%s">%s</a>',
                    esc_url(wp_lostpassword_url()), __('Lost your password?'));
