...
final class WP_Customize_Widgets
{
    ...
    public function __construct($manager)
    {
        ...
        add_filter('should_load_block_editor_scripts_and_styles',
            [$this, 'should_load_block_editor_scripts_and_styles']);
    ...
    public function get_setting_args($id, $overrides = [])
    {
        ...
        if (preg_match($this->setting_id_patterns['sidebar_widgets'], $id, $matches)) {
            ...
            $args['transport'] = current_theme_supports('customize-selective-refresh-widgets') ? 'postMessage'
                : 'refresh';
    ...
    public function get_available_widgets()
    {
        ...
        foreach ($sort as $widget) {
            ...
            $is_disabled = false;
            $is_multi_widget = (isset($wp_registered_widget_controls[$widget['id']]['id_base'])
    ...
    public function call_widget_update($widget_id)
    {
         ...
         */
        $this->manager->set_post_value($setting_id,
