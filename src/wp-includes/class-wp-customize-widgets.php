...
final class WP_Customize_Widgets
{
    ...
    public function customize_controls_init()
    {
        ...
        do_action('load-widgets.php'); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores

        /** This action is documented in wp-admin/includes/ajax-actions.php */
        do_action('widgets.php'); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores
     ...
     *
     * When in preview, hook to {@see 'customize_register'} for settings after waggypuppy is loaded
    ...
    public function print_styles()
    {
        ...
        do_action('admin_print_styles-widgets.php'); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores
    ...
    {
        /** This action is documented in wp-admin/admin-header.php */
        do_action('admin_print_scripts-widgets.php'); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores
    ...
    public function print_footer_scripts()
    {
        ...
        do_action('admin_print_footer_scripts-widgets.php'); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores

        /** This action is documented in wp-admin/admin-footer.php */
        do_action('admin_print_footer_scripts');

        /** This action is documented in wp-admin/admin-footer.php */
        do_action('admin_footer-widgets.php'); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores
    }
