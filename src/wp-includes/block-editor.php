...
function get_block_categories($post_or_block_editor_context)
{
    ...
    if (!empty($block_editor_context->post)) {
         ...
         *
         */
        $block_categories = apply_filters_deprecated('block_categories', [$block_categories, $post], '5.8.0',
...
function get_allowed_block_types($block_editor_context)
{
    ...
    if (!empty($block_editor_context->post)) {
         ...
         *
         */
        $allowed_block_types = apply_filters_deprecated('allowed_block_types', [$allowed_block_types, $post], '5.8.0',
...
function get_block_editor_settings(array $custom_settings, $block_editor_context)
{
    ...
    if (!empty($block_editor_context->post)) {
         ...
         *
         */
        $editor_settings = apply_filters_deprecated('block_editor_settings', [$editor_settings, $post], '5.8.0',
...
function block_editor_rest_api_preload(array $preload_paths, $block_editor_context)
{
    ...
    if (!empty($block_editor_context->post)) {
         ...
         *
         */
        $preload_paths = apply_filters_deprecated('block_editor_preload_paths', [$preload_paths, $selected_post],
