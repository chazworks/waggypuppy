...
function get_search_form( $args = array() ) {
	 ...
	 * @since 5.5.0 The `$args` parameter was added.
	 *
	 * @link https://core.trac.__VAR_WP.org/ticket/19321
	 *
 ...
 * @since 1.5.0
 *
 * @link https://core.trac.__VAR_WP.org/ticket/1458 Explanation of 'wp_meta' action.
 */
function wp_meta() {
	/**
 ...
 * _WP_Editors should not be used directly. See https://core.trac.__VAR_WP.org/ticket/17144.
 *
 * NOTE: Once initialized the TinyMCE editor cannot be safely moved in the DOM. For that reason
 * running wp_editor() inside of a meta box is not a good idea unless only Quicktags is used.
 * On the post edit screen several actions can be used to include additional editors
 * containing TinyMCE: 'edit_page_form', 'edit_form_advanced' and 'dbx_post_sidebar'.
 * See https://core.trac.__VAR_WP.org/ticket/19173 for more information.
 *
...
function get_the_generator( $type = '' ) {
	...
	switch ( $type ) {
		...
		case 'xhtml':
			...
			break;
		case 'atom':
			$gen = '<generator uri="https://__VAR_WP.org/" version="' . esc_attr( get_bloginfo_rss( 'version' ) ) . '">WordPress</generator>';
			break;
		case 'rss2':
			$gen = '<generator>' . sanitize_url( 'https://__VAR_WP.org/?v=' . get_bloginfo_rss( 'version' ) ) . '</generator>';
			break;
		case 'rdf':
			$gen = '<admin:generatorAgent rdf:resource="' . sanitize_url( 'https://__VAR_WP.org/?v=' . get_bloginfo_rss( 'version' ) ) . '" />';
			break;
		case 'comment':
 ...
 * @return string HTML attribute or empty string.
 */
function __checked_selected_helper( $helper, $current, $display, $type ) { // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
