                ...
                <li class="customize-control assigned-menu-locations-title">
                    ...
                    <p>
                        ...
                        /* translators: 1: Documentation URL, 2: Additional link attributes, 3: Accessibility text. */
                            _x('(If you plan to use a menu <a href="%1$s" %2$s>widget%3$s</a>, skip this step.)',
                                'menu locations'),
                            __('https://wp.org/documentation/article/manage-wordpress-widgets/'),
                    ...
                    <# } else { #>
                    <p><?php echo _x('Here&#8217;s where this menu appears. If you would like to change that, pick another location.',
                            'menu locations'); ?></p>
                    <# } #>
                </li>
                ...
                <?php foreach (get_registered_nav_menus() as $location => $description) : ?>
                    ...
                    <li class="customize-control customize-control-checkbox assigned-menu-location">
                        <span class="customize-inside-control-row">
                            <input id="{{ elementId }}" type="checkbox" data-menu-id="{{ data.menu_id }}"
                                   data-location-id="<?php echo esc_attr($location); ?>" class="menu-location"/>
                            <label for="{{ elementId }}">
