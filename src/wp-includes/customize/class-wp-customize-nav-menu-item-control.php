            ...
            <div class="menu-item-handle">
                ...
                <span class="item-controls">
                    ...
                    <# if ( 0 === data.depth ) { #>
                        ...
                        printf(__('Edit %1$s (%2$s, %3$d of %4$d)'),
                    ...
                    <# } else if ( 1 === data.depth ) { #>
                        ...
                        printf(__('Edit %1$s (%2$s, sub-item %3$d of %4$d under %5$s)'),
                            '{{ data.title || data.original_title || wp.customize.Menus.data.l10n.untitled }}',
                            '{{ data.item_type_label }}', '', '', '');
                        ?>
                    <# } else { #>
                        ...
                        printf(__('Edit %1$s (%2$s, sub-item %3$d of %4$d under %5$s, level %6$s)'),
                            '{{ data.title || data.original_title || wp.customize.Menus.data.l10n.untitled }}',
                            '{{ data.item_type_label }}', '', '', '', '{{data.depth}}');
                        ?>
                    <# } #>
