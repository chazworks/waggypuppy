...
class WP_Customize_Theme_Control extends WP_Customize_Control
{
    ...
    public function content_template()
    {
        ...
        <div class="theme" tabindex="0" aria-describedby="{{ data.section }}-{{ data.theme.id }}-action">
            ...
            <span class="more-details theme-details" id="{{ data.section }}-{{ data.theme.id }}-action"
            ...
            <div class="theme-id-container">
                ...
                <div class="theme-actions">
                    ...
                    ?>
                    <a href="{{{ data.theme.actions.activate }}}" class="button button-primary activate"
            ...
            <div class="theme-id-container">
                ...
                <div class="theme-actions">
                    ...
                    <button type="button" class="button button-primary theme-install preview"
                            aria-label="<?php echo esc_attr($install_label); ?>" data-slug="{{ data.theme.id }}"
