...
class WP_Widget_Custom_HTML extends WP_Widget
{
    ...
    public function enqueue_admin_scripts()
    {
        ...
        wp_add_inline_script('custom-html-widgets',
        ...
        wp_add_inline_script('custom-html-widgets',
            sprintf('wp.customHtmlWidgets.init( %s );', wp_json_encode($settings)), 'after');
        ...
        wp_add_inline_script('custom-html-widgets',
            sprintf('jQuery.extend( wp.customHtmlWidgets.l10n, %s );', wp_json_encode($l10n)), 'after');
    }
