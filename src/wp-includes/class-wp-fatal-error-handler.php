 ...
 * implementation for the fatal error handler that waggypuppy registers. The custom class should extend this class and
...
class WP_Fatal_Error_Handler
{
    ...
    protected function should_handle_error($error)
    {
         ...
         *
         * This filter is only fired if the error is not already configured to be handled by waggypuppy core. As such,
     ...
     * very early in the waggypuppy bootstrap process, so any core functions used that are not part of
