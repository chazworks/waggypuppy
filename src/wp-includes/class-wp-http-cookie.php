 ...
 *
 * @todo The waggypuppy convention is to use underscores instead of camelCase for function and method
...
class WP_Http_Cookie
{
     ...
     */
    public function getHeaderValue()  // phpcs:ignore __VAR_WP.NamingConventions.ValidFunctionName.MethodNameInvalid
    {
     ...
     * @return string
     */
    public function getFullHeader()  // phpcs:ignore __VAR_WP.NamingConventions.ValidFunctionName.MethodNameInvalid
    {
