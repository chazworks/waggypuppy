...
function wp_map_sidebars_widgets($existing_sidebars_widgets)
{
    ...
    foreach ($existing_sidebars_widgets as $sidebar => $widgets) {
        if ('wp_inactive_widgets' === $sidebar || str_starts_with($sidebar, 'orphaned_widgets')) {
            $new_sidebars_widgets['wp_inactive_widgets'] = array_merge($new_sidebars_widgets['wp_inactive_widgets'],
                (array)$widgets);
                    ...
                    foreach ($existing_sidebars_widgets as $sidebar => $widgets) {
                        ...
                        foreach ($slug_group as $slug) {
                            ...
                            if (!empty($existing_sidebars_widgets[$sidebar])) {
                                ...
                                $new_sidebars_widgets[$new_sidebar] = array_merge($new_sidebars_widgets[$new_sidebar],
        ...
        <p>
            ...
            if ($inputs['show_date']) : ?>
                <input id="rss-show-date-<?php echo $esc_number; ?>"
                       name="widget-rss[<?php echo $esc_number; ?>][show_date]" type="checkbox"
 ...
 * See https://core.trac.wp.org/ticket/53569.
 *
