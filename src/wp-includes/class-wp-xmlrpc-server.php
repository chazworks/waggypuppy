...
class wp_xmlrpc_server extends IXR_Server {
	...
	public function wp_deletePage( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_deletePage', $page_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_newCategory( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newCategory', $cat_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_deleteCategory( $args ) {
		...
		if ( true == $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteCategory', $category_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_deleteComment( $args ) {
		...
		if ( $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteComment', $comment_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_editComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_editComment', $comment_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_newComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newComment', $comment_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_newPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_newPost', $post_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_editPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_editPost', $post_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_deletePost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_deletePost', $post_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_newPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newPost', $post_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_editPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_editPost', $post_id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_newMediaObject( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newMediaObject', $id, $args ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidHookName.NotLowercase
