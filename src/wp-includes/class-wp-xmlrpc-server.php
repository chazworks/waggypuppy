...
class wp_xmlrpc_server extends IXR_Server
{
    ...
    public function wp_getTaxonomy($args)
    {
        ...
        if (isset($args[4])) {
             ...
             *
             */
            $fields = apply_filters('xmlrpc_default_taxonomy_fields', ['labels', 'cap', 'object_type'],
                'wp.getTaxonomy');
        }
    ...
    public function wp_newComment($args)
    {
        ...
        $comment['comment_parent'] = isset($content_struct['comment_parent'])
            ? absint($content_struct['comment_parent']) : 0;
    ...
    public function wp_getPostType($args)
    {
        ...
        if (isset($args[4])) {
             ...
             *
             */
            $fields = apply_filters('xmlrpc_default_posttype_fields', ['labels', 'cap', 'taxonomies'],
                'wp.getPostType');
        }
    ...
    public function wp_getRevisions($args)
    {
        ...
        if (isset($args[4])) {
             ...
             *
             */
            $fields = apply_filters('xmlrpc_default_revision_fields', ['post_date', 'post_date_gmt'],
                'wp.getRevisions');
        }
    ...
    public function pingback_ping($args)
    {
        ...
        if ($post_id) {
            ...
            return $this->pingback_error(33,
                __('The specified target URL cannot be used as a target. It either does not exist, or it is not a pingback-enabled resource.'));
        }
        $post_id = (int)$post_id;
        ...
        $user_agent = apply_filters('http_headers_useragent',
            'waggypuppy/' . get_bloginfo('version') . '; ' . get_bloginfo('url'), $pagelinkedfrom);
