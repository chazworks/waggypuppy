<?php
/**
 * Deprecated pluggable functions from past waggypuppy versions. You shouldn't use these
...
if (!function_exists('wp_get_cookie_login')):
     ...
     * used anywhere in waggypuppy. Also, plugins shouldn't use it either.
     *
 ...
 * @deprecated 3.5.0
 *
 * @link https://wp.org/plugins/atom-publishing-protocol/
 */
