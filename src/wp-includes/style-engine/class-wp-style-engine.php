...
final class WP_Style_Engine
{
    ...
    public static function parse_block_styles($block_styles, $options)
    {
        ...
        foreach (static::BLOCK_STYLE_DEFINITIONS_METADATA as $definition_group_key => $definition_group_style) {
            ...
            foreach ($definition_group_style as $style_definition) {
                ...
                $parsed_styles['classnames'] = array_merge($parsed_styles['classnames'],
                    static::get_classnames($style_value, $style_definition));
                $parsed_styles['declarations'] = array_merge($parsed_styles['declarations'],
                    static::get_css_declarations($style_value, $style_definition, $options));
            }
        }
    ...
    protected static function get_css_declarations($style_value, $style_definition, $options = [])
    {
        ...
        $should_skip_css_vars = isset($options['convert_vars_to_classnames'])
            && true
            === $options['convert_vars_to_classnames'];
    ...
    protected static function get_individual_property_css_declarations(
        ...
        foreach ($style_value as $css_property => $value) {
            ...
            if ($style_definition && isset($style_definition['property_keys']['individual'])) {
                ...
                $individual_css_property = sprintf($style_definition['property_keys']['individual'],
