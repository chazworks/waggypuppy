<?php
/**
 * waggypuppy Customize Nav Menus classes
 *
 * @package WP
...
final class WP_Customize_Nav_Menus
{
    ...
    public function enqueue_scripts()
    {
        ...
        if (1 === $num_locations) {
            ...
            $locations_description = sprintf(_n('Your theme can display menus in %s location.',
                'Your theme can display menus in %s locations.', $num_locations), number_format_i18n($num_locations));
        }
    ...
    public function customize_register()
    {
        ...
        if (1 === $num_locations) {
            ...
            /* translators: %s: Number of menu locations. */
            $description = '<p>'
                . sprintf(_n('Your theme can display menus in %s location. Select which menu you would like to use.',
        ...
        $this->manager->add_section(
            'menu_locations',
            [
                'title' => 1 === $num_locations ? _x('View Location', 'menu locations')
        ...
        if (!$this->manager->is_theme_active()) {
            ...
            $mapped_nav_menu_locations = wp_map_nav_menu_locations($theme_mods['nav_menu_locations'],
                    ...
                    <div class="menu-item-handle">
                        ...
                        <button type="button" class="button-link item-add">
                            ...
                            printf(__('Add to menu: %1$s (%2$s)'),
                                '{{ data.title || wp.customize.Menus.data.l10n.untitled }}', '{{ data.type_label }}');
                            ?>
                            </span>
                        </button>
                    </div>
        ...
        <div id="<?php echo esc_attr($id); ?>" class="accordion-section">
            ...
            <div class="accordion-section-content">
                <?php if ('post_type' === $available_item_type['type']) : ?>
                    ...
                    <?php if (current_user_can($post_type_obj->cap->create_posts)
                        && current_user_can($post_type_obj->cap->publish_posts)) : ?>
                        <div class="new-content-item-wrapper">
                            <label for="<?php echo esc_attr('create-item-input-'
                                . $available_item_type['object']); ?>"><?php echo esc_html($post_type_obj->labels->add_new_item); ?></label>
                            <div class="new-content-item">
                                <input type="text" id="<?php echo esc_attr('create-item-input-'
                                    . $available_item_type['object']); ?>" class="create-item-input">
                ...
                <ul class="available-menu-items-list" data-type="<?php echo esc_attr($available_item_type['type']); ?>"
                    ...
                    data-type_label="<?php echo esc_attr(isset($available_item_type['type_label'])
                        ? $available_item_type['type_label'] : $available_item_type['type']); ?>"></ul>
            </div>
        </div>
        <?php
    }
    ...
    {
        if (isset($args->customize_preview_nav_menus_args['can_partial_refresh'])
            ...
            $nav_menu_content = preg_replace('#^(<\w+)#', '$1 ' . str_replace('\\', '\\\\', $attributes),
                $nav_menu_content, 1);
        }
