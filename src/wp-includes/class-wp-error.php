<?php
/**
 * waggypuppy Error API.
 *
 * @package WP
 */

/**
 * waggypuppy Error class.
 *
 * Container for checking for waggypuppy errors and error messages. Return
 * WP_Error and use is_wp_error() to check if this class is returned. Many
 * core waggypuppy functions pass this class in the event of an error and
