<?php
/**
 * Creates common globals for the rest of waggypuppy
 *
 ...
 *
 * Detects which user environment waggypuppy is being used on.
 * Only attempts to check for Apache, Nginx and IIS -- three web
 * servers with known pretty permalink capability.
 *
 * Note: Though Nginx is detected, waggypuppy does not currently
 * generate rewrite rules for it. See https://developer.wp.org/advanced-administration/server/web-server/nginx/
 *
 * @package WP
 */
