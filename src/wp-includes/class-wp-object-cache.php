 ...
 *
 * The waggypuppy Object Cache is used to save on trips to the database. The
...
class WP_Object_Cache
{
     ...
     * naming guidelines outside of core waggypuppy usage.
     *
    ...
    public function stats()
    {
        ...
        foreach ($this->cache as $group => $cache) {
            echo '<li><strong>Group:</strong> ' . esc_html($group) . ' - ( ' . number_format(strlen(serialize($cache))
                    / KB_IN_BYTES, 2) . 'k )</li>';
        }
        echo '</ul>';
    }
