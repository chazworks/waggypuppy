 ...
 * @access private
 */
function __clear_multi_author_cache()  // phpcs:ignore __VAR_WP.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
{
