...
final class _WP_Editors
{
    ...
    public static function editor($content, $editor_id, $settings = [])
    {
        ...
        if (self::$this_tinymce) {
            ...
            if (self::$this_quicktags) {
                ...
                $buttons .= '<button type="button" id="'
                    . $editor_id_attr
                    . '-tmce" class="wp-switch-editor switch-tmce"'
                    .
                    ' data-wp-editor-id="'
                    . $editor_id_attr
                    . '">'
                ...
                $buttons .= '<button type="button" id="'
                    . $editor_id_attr
                    . '-html" class="wp-switch-editor switch-html"'
                    .
                    ' data-wp-editor-id="'
                    . $editor_id_attr
                    . '">'
        ...
        if (self::$this_quicktags) {
            if ('content' === $editor_id && !empty($GLOBALS['current_screen'])
                && 'post'
                === $GLOBALS['current_screen']->base) {
        ...
        if (self::$this_tinymce) {
                ...
                if ($set['teeny']) {
                    ...
                    if (!empty($mce_external_plugins)) {
                        ...
                        foreach ($mce_external_plugins as $name => $url) {
                            ...
                            $ext_plugins .= 'tinyMCEPreInit.load_ext("'
                                . $plugurl
                                . '", "'
                                . $mce_locale
                                . '");'
            ...
            if ($post) {
                ...
                if (false !== $page_template) {
                    $page_template = empty($page_template) ? 'default'
                        : str_replace('.', '-', basename($page_template, '.php'));
    ...
    public static function wp_link_dialog()
    {
        ...
        <div id="wp-link-wrap" class="wp-core-ui" style="display: none" role="dialog" aria-modal="true"
