...
function wp_print_media_templates()
{
            ...
            <?php else : ?>
                ...
                <div class="post-upload-ui" id="post-upload-info">
                    ...
                    <p class="suggested-dimensions">
                        ...
                        printf(__('Suggested image dimensions: %1$s by %2$s pixels.'), '{{data.suggestedWidth}}',
    ...
    <script type="text/html" id="tmpl-attachment-details-two-column">
        ...
        <div class="attachment-info">
            ...
            <div class="actions">
                <# if ( data.link ) { #>
                <?php
                $view_media_text = ('1' === get_option('wp_attachment_pages_enabled')) ? __('View attachment page')
                    : __('View media file');
                ?>
    ...
    <script type="text/html" id="tmpl-attachment">
        <div
            class="attachment-preview js--select-attachment type-{{ data.type }} subtype-{{ data.subtype }} {{ data.orientation }}">
            <div class="thumbnail">
                <# if ( data.uploading ) { #>
                <div class="media-progress-bar">
            ...
            <div class="embed-media-settings embed-video-settings">
                ...
                <span class="setting" data-setting="content">
                    ...
                    if ( ! _.isEmpty( data.model.content ) ) {
                        ...
                        <button type="button"
                                class="button-link remove-setting remove-track"><?php _ex('Remove video track',
                                'media'); ?></button><br/>
                        <# } ); #>
                    <# } else { #>
                    <span
                        class="name"><?php _e('Tracks (subtitles, captions, descriptions, chapters, or metadata)'); ?></span><br/>
    ...
    <script type="text/html" id="tmpl-site-icon-preview-crop">
        ...
        <div class="site-icon-preview crop">
            <div class="image-preview-wrap app-icon-preview">
                <img id="preview-app-icon" src="{{ data.url }}" class="app-icon-preview"
                     alt="<?php esc_attr_e('Preview as an app icon'); ?>"/>
            </div>
            <div class="site-icon-preview-browser">
                <svg role="img" aria-hidden="true" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="site-icon-preview-tab">
                    <div class="image-preview-wrap browser">
                        <img id="preview-favicon" src="{{ data.url }}" class="browser-icon-preview"
                             alt="<?php esc_attr_e('Preview as a browser icon'); ?>"/>
                    </div>
                    <div class="site-icon-preview-site-title" aria-hidden="true"><# print(
