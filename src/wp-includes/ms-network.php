...
function _prime_network_caches($network_ids)
{
    ...
    if (! empty($non_cached_ids)) {
        $fresh_networks = $wpdb->get_results(sprintf("SELECT $wpdb->site.* FROM $wpdb->site WHERE id IN (%s)", implode(',', array_map('intval', $non_cached_ids)))); // phpcs:ignore __VAR_WP.DB.PreparedSQL.NotPrepared
