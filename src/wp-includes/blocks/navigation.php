...
function block_core_navigation_add_directives_to_submenu($tags, $block_attributes)
{
    while ($tags->next_tag(
        ...
        $tags->set_attribute('data-wp-context',
            '{ "submenuOpenedBy": { "click": false, "hover": false, "focus": false }, "type": "submenu" }');
...
function block_core_navigation_build_css_colors($attributes)
{
    ...
    if ($has_named_overlay_background_color) {
        ...
        $colors['overlay_inline_styles'] .= sprintf('background-color: %s;',
...
function block_core_navigation_parse_blocks_from_menu_items($menu_items, $menu_items_by_parent_id)
{
    ...
    foreach ($menu_items as $menu_item) {
        ...
        $block['innerBlocks'] = isset($menu_items_by_parent_id[$menu_item->ID])
            ? block_core_navigation_parse_blocks_from_menu_items($menu_items_by_parent_id[$menu_item->ID],
                $menu_items_by_parent_id)
            : [];
 ...
 */
if (!has_filter('rest_pre_insert_wp_navigation', 'update_ignored_hooked_blocks_postmeta')
 ...
 */
if (!has_filter('rest_prepare_wp_navigation', 'insert_hooked_blocks_into_rest_response')
