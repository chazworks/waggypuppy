...
if ( ! function_exists( 'wp_mail' ) ) :
	...
	function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
		 ...
		 * See https://core.trac.__VAR_WP.org/ticket/5007.
		 */
		if ( ! isset( $from_email ) ) {
...
if ( ! function_exists( 'wp_salt' ) ) :
	 ...
	 * {@link https://api.__VAR_WP.org/secret-key/1.1/salt/ secret key created} just
	 * for you.
	 *
	 ...
	 * @since 2.5.0
	 *
	 * @link https://api.__VAR_WP.org/secret-key/1.1/salt/ Create secrets for wp-config.php
	 *
