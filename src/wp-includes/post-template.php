    ...
    if (count($content) > 1) {
        if ($elements['more']) {
            ...
            if (!empty($more_link_text)) {
                 ...
                 *
                 */
                $output .= apply_filters('the_content_more_link', ' <a href="'
                    . get_permalink($_post)
                    . "#more-{$_post->ID}\" class=\"more-link\">$more_link_text</a>", $more_link_text);
            }
        ...
        if ('number' === $parsed_args['next_or_number']) {
            ...
            for ($i = 1; $i <= $numpages; $i++) {
                ...
                if ($i !== $page || !$more && 1 === $page) {
                    ...
                    $link = '<span class="post-page-numbers current" aria-current="'
...
function get_the_password_form($post = 0)
{
	...
	<p><label for="'
        ...
        . $label
        . '" type="password" spellcheck="false" size="20" /></label> <input type="submit" name="Submit" value="'
