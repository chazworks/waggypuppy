...
class getid3_asf extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if ($thisfile_asf_headerobject['objectid'] != GETID3_ASF_Header_Object) {
            ...
            return $this->error('ASF header GUID {'
                . $this->BytestringToGUID($thisfile_asf_headerobject['objectid'])
        ...
        for ($HeaderObjectsCounter = 0; $HeaderObjectsCounter
        < $thisfile_asf_headerobject['headerobjects']; $HeaderObjectsCounter++) {
            ...
            switch ($NextObjectGUID) {
                case GETID3_ASF_File_Properties_Object:
                    ...
                    $thisfile_asf_filepropertiesobject['flags_raw'] = getid3_lib::LittleEndian2Int(substr($ASFHeaderData,
                        $offset, 4));
                    $offset += 4;
                    $thisfile_asf_filepropertiesobject['flags']['broadcast'] = (bool)($thisfile_asf_filepropertiesobject['flags_raw']
                        & 0x0001);
                    $thisfile_asf_filepropertiesobject['flags']['seekable'] = (bool)($thisfile_asf_filepropertiesobject['flags_raw']
                        & 0x0002);
                    ...
                    if ($thisfile_asf_filepropertiesobject['flags']['broadcast']) {
                        ...
                        $info['playtime_seconds'] = ($thisfile_asf_filepropertiesobject['play_duration'] / 10000000)
                            - ($thisfile_asf_filepropertiesobject['preroll'] / 1000);

                        //$info['bitrate'] = $thisfile_asf_filepropertiesobject['max_bitrate'];
                        $info['bitrate'] = getid3_lib::SafeDiv($thisfile_asf_filepropertiesobject['filesize'] * 8,
                ...
                case GETID3_ASF_Stream_Properties_Object:
                    ...
                    $StreamPropertiesObjectData['flags']['encrypted'] = (bool)($StreamPropertiesObjectData['flags_raw']
                        & 0x8000);
                    ...
                    switch ($StreamPropertiesObjectData['stream_type']) {
                        case GETID3_ASF_Audio_Media:
                            $thisfile_audio['dataformat'] = (!empty($thisfile_audio['dataformat'])
                                ? $thisfile_audio['dataformat'] : 'asf');
                            $thisfile_audio['bitrate_mode'] = (!empty($thisfile_audio['bitrate_mode'])
                        ...
                        case GETID3_ASF_Video_Media:
                            $thisfile_video['dataformat'] = (!empty($thisfile_video['dataformat'])
                                ? $thisfile_video['dataformat'] : 'asf');
                            $thisfile_video['bitrate_mode'] = (!empty($thisfile_video['bitrate_mode'])
                ...
                case GETID3_ASF_Header_Extension_Object:
                    ...
                    if ($thisfile_asf_headerextensionobject['reserved_1'] != GETID3_ASF_Reserved_1) {
                        $this->warning('header_extension_object.reserved_1 GUID ('
                    ...
                    if ($thisfile_asf_headerextensionobject['reserved_2'] != 6) {
                        $this->warning('header_extension_object.reserved_2 ('
                ...
                case GETID3_ASF_Codec_List_Object:
                    ...
                    if ($thisfile_asf_codeclistobject['reserved']
                        != $this->GUIDtoBytestring('86D15241-311D-11D0-A3A4-00A0C90348F6')) {
                        $this->warning('codec_list_object.reserved GUID {'
                    ...
                    $offset += 4;
                    for ($CodecEntryCounter = 0; $CodecEntryCounter
                    < $thisfile_asf_codeclistobject['codec_entries_count']; $CodecEntryCounter++) {
                        // shortcut
                        ...
                        $CodecNameLength = getid3_lib::LittleEndian2Int(substr($ASFHeaderData, $offset, 2))
                        ...
                        $CodecDescriptionLength = getid3_lib::LittleEndian2Int(substr($ASFHeaderData, $offset, 2))
                            * 2; // 2 bytes per character
                        $offset += 2;
                        ...
                        if ($thisfile_asf_codeclistobject_codecentries_current['type_raw'] == 2) { // audio codec
                            ...
                            if (strpos($thisfile_asf_codeclistobject_codecentries_current['description'], ',')
                                === false) {
                                $this->warning('[asf][codec_list_object][codec_entries]['
                                    . $CodecEntryCounter
                                ...
                                [$AudioCodecBitrate, $AudioCodecFrequency, $AudioCodecChannels] = explode(',',
                                ...
                                if (!isset($thisfile_audio['bitrate']) && strstr($AudioCodecBitrate, 'kbps')) {
                                    $thisfile_audio['bitrate'] = (int)trim(str_replace('kbps', '', $AudioCodecBitrate))
                                        * 1000;
                                }
                                //if (!isset($thisfile_video['bitrate']) && isset($thisfile_audio['bitrate']) && isset($thisfile_asf['file_properties_object']['max_bitrate']) && ($thisfile_asf_codeclistobject['codec_entries_count'] > 1)) {
                                if (empty($thisfile_video['bitrate'])
                                ...
                                switch ($AudioCodecFrequency) {
                                    ...
                                    default:
                                        $this->warning('unknown frequency: "'
                                            . $AudioCodecFrequency
                                            . '" ('
                                            . $this->TrimConvert($thisfile_asf_codeclistobject_codecentries_current['description'])
                                            . ')');
                ...
                case GETID3_ASF_Script_Command_Object:
                    ...
                    if ($thisfile_asf_scriptcommandobject['reserved']
                        != $this->GUIDtoBytestring('4B1ACBE3-100B-11D0-A39B-00A0C90348F6')) {
                        $this->warning('script_command_object.reserved GUID {'
                    ...
                    $thisfile_asf_scriptcommandobject['command_types_count'] = getid3_lib::LittleEndian2Int(substr($ASFHeaderData,
                        $offset, 2));
                    $offset += 2;
                    for ($CommandTypesCounter = 0; $CommandTypesCounter
                    < $thisfile_asf_scriptcommandobject['command_types_count']; $CommandTypesCounter++) {
                        $CommandTypeNameLength = getid3_lib::LittleEndian2Int(substr($ASFHeaderData, $offset, 2))
                            * 2; // 2 bytes per character
                        $offset += 2;
                    ...
                    for ($CommandsCounter = 0; $CommandsCounter
                    < $thisfile_asf_scriptcommandobject['commands_count']; $CommandsCounter++) {
                ...
                case GETID3_ASF_Marker_Object:
                    ...
                    if ($thisfile_asf_markerobject['reserved']
                        != $this->GUIDtoBytestring('4CFEDB20-75F6-11CF-9C0F-00A0C90349CB')) {
                        $this->warning('marker_object.reserved GUID {'
                    ...
                    if ($thisfile_asf_markerobject['reserved_2'] != 0) {
                        $this->warning('marker_object.reserved_2 ('
                    ...
                    for ($MarkersCounter = 0; $MarkersCounter
                    < $thisfile_asf_markerobject['markers_count']; $MarkersCounter++) {
                        ...
                        $PaddingLength = $thisfile_asf_markerobject['markers'][$MarkersCounter]['entry_length']
                            - 4
                            - 4
                            - 4
                            - $thisfile_asf_markerobject['markers'][$MarkersCounter]['marker_description_length'];
                ...
                case GETID3_ASF_Bitrate_Mutual_Exclusion_Object:
                    ...
                    $offset += 16;
                    if (($thisfile_asf_bitratemutualexclusionobject['reserved'] != GETID3_ASF_Mutex_Bitrate)
                        && ($thisfile_asf_bitratemutualexclusionobject['reserved'] != GETID3_ASF_Mutex_Unknown)) {
                        $this->warning('bitrate_mutual_exclusion_object.reserved GUID {'
                            ...
                            . $this->BytestringToGUID(GETID3_ASF_Mutex_Bitrate)
                            . '} or  "GETID3_ASF_Mutex_Unknown" GUID {'
                            . $this->BytestringToGUID(GETID3_ASF_Mutex_Unknown)
                            . '}');
                        //return false;
                        break;
                    }
                    $thisfile_asf_bitratemutualexclusionobject['stream_numbers_count'] = getid3_lib::LittleEndian2Int(substr($ASFHeaderData,
                        $offset, 2));
                    $offset += 2;
                    for ($StreamNumberCounter = 0; $StreamNumberCounter
                    < $thisfile_asf_bitratemutualexclusionobject['stream_numbers_count']; $StreamNumberCounter++) {
                ...
                case GETID3_ASF_Error_Correction_Object:
                    ...
                    switch ($thisfile_asf_errorcorrectionobject['error_correction_type']) {
                        ...
                        default:
                            $this->warning('error_correction_object.error_correction_type GUID {'
                                ...
                                . $this->BytestringToGUID(GETID3_ASF_No_Error_Correction)
                ...
                case GETID3_ASF_Extended_Content_Description_Object:
                    ...
                    $thisfile_asf_extendedcontentdescriptionobject['content_descriptors_count'] = getid3_lib::LittleEndian2Int(substr($ASFHeaderData,
                        $offset, 2));
                    $offset += 2;
                    for ($ExtendedContentDescriptorsCounter = 0; $ExtendedContentDescriptorsCounter
                    < $thisfile_asf_extendedcontentdescriptionobject['content_descriptors_count']; $ExtendedContentDescriptorsCounter++) {
                        // shortcut
                        ...
                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['base_offset'] = $offset
                            + 30;
                        ...
                        switch ($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_type']) {
                            ...
                            default:
                                $this->warning('extended_content_description.content_descriptors.'
                        ...
                        switch ($this->TrimConvert(strtolower($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']))) {
                            ...
                            case 'tracknumber':
                                ...
                                foreach ($thisfile_asf_comments['track_number'] as $key => $value) {
                                    if (preg_match('/^[0-9\x00]+$/', $value)) {
                                        $thisfile_asf_comments['track_number'][$key] = intval(str_replace("\x00", '',
                                            $value));
                                    }
                                }
                                break;
                            ...
                            case 'wm/track':
                                if (empty($thisfile_asf_comments['track_number'])) {
                                    $thisfile_asf_comments['track_number'] = [
                                        1
                                        + (int)$this->TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']),
                                    ];
                                }
                                break;
                            ...
                            case 'id3':
                                ...
                                if ($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_length']
                                    > 1024) {
                ...
                case GETID3_ASF_Stream_Bitrate_Properties_Object:
                    ...
                    < $thisfile_asf_streambitratepropertiesobject['bitrate_records_count']; $BitrateRecordsCounter++) {
                        $thisfile_asf_streambitratepropertiesobject['bitrate_records'][$BitrateRecordsCounter]['flags_raw'] = getid3_lib::LittleEndian2Int(substr($ASFHeaderData,
                            $offset, 2));
                        $offset += 2;
                        $thisfile_asf_streambitratepropertiesobject['bitrate_records'][$BitrateRecordsCounter]['flags']['stream_number'] = $thisfile_asf_streambitratepropertiesobject['bitrate_records'][$BitrateRecordsCounter]['flags_raw']
                            & 0x007F;
                ...
                default:
                    ...
                    if ($this->GUIDname($NextObjectGUIDtext)) {
                        ...
                        $this->warning('unknown GUID {' . $NextObjectGUIDtext . '} in ASF header at offset ' . ($offset
                                - 16
                                - 8));
                    }
                    $offset += ($NextObjectSize - 16 - 8);
                    ...
                    case GETID3_ASF_Audio_Media:
                        ...
                        if (!empty($thisfile_asf['stream_bitrate_properties_object']['bitrate_records'])) { // @phpstan-ignore-line
                            foreach ($thisfile_asf['stream_bitrate_properties_object']['bitrate_records'] as $dummy => $dataarray) {
                                if (isset($dataarray['flags']['stream_number'])
            ...
            switch ($NextObjectGUID) {
                case GETID3_ASF_Data_Object:
                    ...
                    if ($thisfile_asf_dataobject['reserved'] != 0x0101) {
                        $this->warning('data_object.reserved (0x' . sprintf('%04X',
                                $thisfile_asf_dataobject['reserved']) . ') does not match expected value of "0x0101"');
                        //return false;
                        break;
                    }
                ...
                case GETID3_ASF_Simple_Index_Object:
                    ...
                    $IndexEntriesData = $SimpleIndexObjectData . $this->fread(6
                            * $thisfile_asf_simpleindexobject['index_entries_count']);
                    for ($IndexEntriesCounter = 0; $IndexEntriesCounter
                    < $thisfile_asf_simpleindexobject['index_entries_count']; $IndexEntriesCounter++) {
                ...
                case GETID3_ASF_Index_Object:
                    ...
                    for ($IndexSpecifiersCounter = 0; $IndexSpecifiersCounter
                    < $thisfile_asf_asfindexobject['index_specifiers_count']; $IndexSpecifiersCounter++) {
                    ...
                    for ($IndexEntryCounter = 0; $IndexEntryCounter
                    < $thisfile_asf_asfindexobject['index_entry_count']; $IndexEntryCounter++) {
                        for ($IndexSpecifiersCounter = 0; $IndexSpecifiersCounter
                        < $thisfile_asf_asfindexobject['index_specifiers_count']; $IndexSpecifiersCounter++) {
        ...
        if (isset($thisfile_asf_codeclistobject['codec_entries'])) {
            foreach ($thisfile_asf_codeclistobject['codec_entries'] as $streamnumber => $streamdata) {
                switch ($streamdata['type_raw']) {
                    ...
                    default:
                        $this->warning('Unknown streamtype: [codec_list_object][codec_entries]['
                            . $streamnumber
                            . '][type_raw] == '
                            . $streamdata['type_raw']);
                        break;
        ...
        if (isset($info['audio'])) {
            ...
            $thisfile_audio['dataformat'] = (!empty($thisfile_audio['dataformat']) ? $thisfile_audio['dataformat']
                : 'asf');
        }
        if (!empty($thisfile_video['dataformat'])) {
            $thisfile_video['lossless'] = (isset($thisfile_audio['lossless']) ? $thisfile_audio['lossless'] : false);
            $thisfile_video['pixel_aspect_ratio'] = (isset($thisfile_audio['pixel_aspect_ratio'])
                ? $thisfile_audio['pixel_aspect_ratio'] : (float)1);
            $thisfile_video['dataformat'] = (!empty($thisfile_video['dataformat']) ? $thisfile_video['dataformat']
                : 'asf');
        }
        if (!empty($thisfile_video['streams'])) {
            ...
            foreach ($thisfile_video['streams'] as $key => $valuearray) {
                if (($valuearray['resolution_x'] > $thisfile_video['resolution_x'])
        ...
        $info['bitrate'] = 0
            + (isset($thisfile_audio['bitrate']) ? $thisfile_audio['bitrate'] : 0)
            + (isset($thisfile_video['bitrate']) ? $thisfile_video['bitrate'] : 0);
            ...
            switch ($thisObject['guid']) {
                case GETID3_ASF_Extended_Stream_Properties_Object:
                    ...
                    for ($i = 0; $i < $thisObject['stream_name_count']; $i++) {
                        ...
                        $streamName['stream_name'] = substr($asf_header_extension_object_data, $offset,
                    ...
                    for ($i = 0; $i < $thisObject['payload_extension_system_count']; $i++) {
                        ...
                        $payloadExtensionSystem['extension_system_info'] = substr($asf_header_extension_object_data,
                ...
                case GETID3_ASF_Advanced_Mutual_Exclusion_Object:
                    ...
                    $thisObject['stream_numbers_count'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                        $offset, 2));
                    $offset += 2;

                    for ($i = 0; $i < $thisObject['stream_numbers_count']; $i++) {
                        $thisObject['stream_numbers'][$i] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                            $offset, 2));
                        $offset += 2;
                    }
                ...
                case GETID3_ASF_Stream_Prioritization_Object:
                    $thisObject['priority_records_count'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                        $offset, 2));
                    $offset += 2;
                    ...
                    for ($i = 0; $i < $thisObject['priority_records_count']; $i++) {
                        ...
                        $priorityRecord['stream_number'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                            $offset, 2));
                        $offset += 2;

                        $priorityRecord['flags_raw'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                            $offset, 2));
                        $offset += 2;
                ...
                case GETID3_ASF_Index_Parameters_Object:
                    $thisObject['index_entry_time_interval'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                        $offset, 4));
                    $offset += 4;

                    $thisObject['index_specifiers_count'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                        $offset, 2));
                    $offset += 2;
                    ...
                    for ($i = 0; $i < $thisObject['index_specifiers_count']; $i++) {
                        ...
                        $indexSpecifier['stream_number'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                            $offset, 2));
                        $offset += 2;

                        $indexSpecifier['index_type'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                            $offset, 2));
                        $offset += 2;
                ...
                case GETID3_ASF_Media_Object_Index_Parameters_Object:
                    $thisObject['index_entry_count_interval'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                        $offset, 4));
                    $offset += 4;
                ...
                case GETID3_ASF_Compatibility_Object:
                    $thisObject['profile'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                        $offset, 1));
                    $offset += 1;

                    $thisObject['mode'] = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data,
                        $offset, 1));
                    $offset += 1;
                ...
                default:
                    ...
                    if ($this->GUIDname($thisObject['guid_text'])) {
                        $this->warning('unhandled Header Extension Object GUID "'
                        ...
                        $this->warning('unknown Header Extension Object GUID {'
                            . $thisObject['guid_text']
                            . '} in at offset '
                            . ($offset - 16 - 8));
                    }
