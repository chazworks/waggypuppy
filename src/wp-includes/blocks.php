...
function register_block_script_handle( $metadata, $field_name, $index = 0 ) {
	...
	// Asset file for blocks is optional. See https://core.trac.__VAR_WP.org/ticket/60460.
 ...
 *
 * @link https://developer.__VAR_WP.org/block-editor/reference-guides/block-api/block-styles/
 *
	...
	if ( isset( $block->context['query'] ) ) {
		...
		if ( isset( $block->context['query']['sticky'] ) && ! empty( $block->context['query']['sticky'] ) ) {
			...
			if ( 'only' === $block->context['query']['sticky'] ) {
				 ...
				 *
				 * @see https://core.trac.__VAR_WP.org/ticket/28099
				 */
