...
/**
 * Registers all the default waggypuppy Script Modules.
 *
 * @since 6.7.0
 */
function wp_default_script_modules()
{
    ...
    foreach ($assets as $file_name => $script_module_data) {
        /*
         * Build the waggypuppy Script Module ID from the file name.
        ...
        wp_register_script_module($script_module_id, $path, $script_module_data['dependencies'],
