...
function wp_list_comments($args = [], $comments = null)
{
    ...
    if (null !== $comments) {
        ...
        if ($parsed_args['page'] || $parsed_args['per_page']) {
            ...
            if (!$current_cpage) {
                $current_cpage = 'newest' === get_option('default_comments_page') ? 1
    ...
    if ('' === $parsed_args['page']) {
        if (empty($overridden_cpage)) {
            ...
            $parsed_args['page'] = ('newest' === get_option('default_comments_page'))
                ? get_comment_pages_count($_comments, $parsed_args['per_page'], $threaded) : 1;
    ...
    $output = $walker->paged_walk($_comments, $parsed_args['max_depth'], $parsed_args['page'], $parsed_args['per_page'],
        $parsed_args);
