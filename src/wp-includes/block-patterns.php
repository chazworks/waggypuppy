...
function _register_theme_block_patterns()
{
    ...
    foreach ($themes as $theme) {
        ...
        foreach ($patterns as $file => $pattern_data) {
			...
			// phpcs:ignore __VAR_WP.WP.I18n.NonSingularStringLiteralText,__VAR_WP.WP.I18n.NonSingularStringLiteralDomain,__VAR_WP.WP.I18n.LowLevelTranslationFunction
