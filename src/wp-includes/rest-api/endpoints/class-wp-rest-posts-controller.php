...
class WP_REST_Posts_Controller extends WP_REST_Controller
{
    ...
    public function get_items($request)
    {
        ...
        if (isset($registered['search_semantics'], $request['search_semantics'])
    ...
    protected function prepare_items_query($prepared_args = [], $request = null)
    {
        ...
        foreach ($prepared_args as $key => $value) {
             ...
             */
            $query_args[$key] = apply_filters("rest_query_var-{$key}", $value); // phpcs:ignore __VAR_WP.NamingConventions.ValidHookName.UseUnderscores
        }
    ...
    protected function prepare_item_for_database($request)
    {
         ...
         */
        if ((! empty($schema['properties']['date_gmt']) && $request->has_param('date_gmt') && null === $request['date_gmt']) ||
