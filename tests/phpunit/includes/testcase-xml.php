...
abstract class WP_Test_XML_TestCase extends WP_UnitTestCase {
	 ...
	 */
	public function assertXMLEquals( $expectedXml, $actualXml, $message = '' ) { // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidVariableName.VariableNotSnakeCase
		$this->assertSame( $this->normalizeXML( $expectedXml ), $this->normalizeXML( $actualXml ), $message ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidVariableName.VariableNotSnakeCase
	}
	 ...
	 * @param string $message   Optional. Message to display when the assertion fails.
	 */
	public function assertXMLNotEquals( $expectedXml, $actualXml, $message = '' ) { // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidVariableName.VariableNotSnakeCase
		$this->assertNotEquals( $this->normalizeXML( $expectedXml ), $this->normalizeXML( $actualXml ), $message ); // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidVariableName.VariableNotSnakeCase
	}
}
