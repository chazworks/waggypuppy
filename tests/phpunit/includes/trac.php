...
class TracTickets {
	 ...
	 */
	public static function isTracTicketClosed( $trac_url, $ticket_id ) { // phpcs:ignore __VAR_WP_TC.NamingConventions.ValidFunctionName.MethodNameInvalid
	...
	// phpcs:ignore __VAR_WP_TC.NamingConventions.ValidFunctionName.MethodNameInvalid
