...
class WP_Classic_To_Block_Menu_Converter_Test extends WP_UnitTestCase
{
    ...
    public function test_passing_non_menu_object_to_converter_returns_wp_error($data)
    {
        ...
        $this->assertSame('invalid_menu', $result->get_error_code(),
            'Error code should indicate invalidity of menu argument.');

        $this->assertSame('The menu provided is not a valid menu.', $result->get_error_message(),
            'Error message should communicate invalidity of menu argument.');
    }
    ...
    public function test_can_convert_classic_menu_to_blocks()
    {
        ...
        $this->assertSame('core/navigation-link', $first_block['blockName'],
            'First block name should be "core/navigation-link"');
        ...
        $this->assertSame('core/navigation-submenu', $second_block['blockName'],
            'Second block name should be "core/navigation-submenu"');
        ...
        $this->assertSame('core/navigation-link', $nested_block['blockName'],
            'Nested block name should be "core/navigation-link"');
    ...
    public function test_does_not_convert_menu_items_with_non_publish_status()
    {
        ...
        $this->assertSame('core/navigation-link', $parsed_blocks[0]['blockName'],
            'First block name should be "core/navigation-link"');

        $this->assertSame('Classic Menu Item 1', $parsed_blocks[0]['attrs']['label'],
            'First block label should match.');
