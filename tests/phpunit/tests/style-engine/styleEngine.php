...
class Tests_wpStyleEngine extends WP_UnitTestCase
{
    ...
    public function test_should_return_stylesheet_from_css_rules()
    {
        ...
        $this->assertSame('.saruman{color:white;height:100px;border-style:solid;align-self:unset;}.gandalf{color:grey;height:90px;border-style:dotted;align-self:safe center;}.radagast{color:brown;height:60px;border-style:dashed;align-self:stretch;}',
            $compiled_stylesheet);
    }
    ...
    public function test_should_dedupe_and_merge_css_rules()
    {
        ...
        $this->assertSame('.gandalf{color:white;height:190px;border-style:dotted;padding:10px;margin-bottom:100px;}.dumbledore{color:grey;height:90px;border-style:dotted;}.rincewind{color:grey;height:90px;border-style:dotted;}',
            $compiled_stylesheet);
    }
    ...
    public function test_should_merge_declarations_for_rules_groups()
    {
        ...
        $this->assertSame('@container (min-width: 700px){.saruman{color:black;height:100px;border-style:solid;align-self:stretch;font-family:The-Great-Eye;}}',
            $compiled_stylesheet);
    }
    ...
    public function test_should_return_stylesheet_with_nested_rules()
    {
        ...
        $this->assertSame('.foo{@media (orientation: landscape){background-color:blue;}}.foo{@media (min-width > 1024px){background-color:cotton-blue;}}',
            $compiled_stylesheet);
    }
}
