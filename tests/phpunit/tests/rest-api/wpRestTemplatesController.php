...
class Tests_REST_WpRestTemplatesController extends WP_Test_REST_Controller_Testcase
{
        ...
        return [
            ...
            'template parts: parent theme with non latin characters' => [
                ...
                'args' => [
                    ...
                    'post_content' => file_get_contents($theme_root_dir
                        . '/block-theme-non-latin/parts/small-header-test.html'),
            ...
            'template: parent theme with non latin name' => [
                ...
                'args' => [
                    ...
                    'post_content' => file_get_contents($theme_root_dir
                        . 'block-theme-non-latin/templates/page-test.html'),
            ...
            'template: parent theme deprecated path' => [
                ...
                'args' => [
                    ...
                    'post_title' => 'Home Page Template',
                    'post_content' => file_get_contents($theme_root_dir
                        . 'block-theme-deprecated-path/block-templates/page-home.html'),
                    'post_excerpt' => 'Description of page home template.',
                ],
            ],
            ...
            'template part: subdir with _-[]. characters' => [
                ...
                'args' => [
                    ...
                    'post_content' => file_get_contents($theme_root_dir
                        . 'block_theme-[0.4.0]/parts/large-header.html'),
            ...
            'template: subdir with _-[]. characters' => [
                ...
                'args' => [
                    ...
                    'post_content' => file_get_contents($theme_root_dir
                        . 'block_theme-[0.4.0]/templates/page-large-header.html'),
    ...
    public function test_get_template_fallback()
    {
        ...
        $request->set_param('is_custom', false);
        $response = rest_get_server()->dispatch($request);
        $this->assertSame('index', $response->get_data()['slug'],
    ...
    public function test_prepare_item_for_database()
    {
        ...
        $this->assertObjectHasProperty('post_type', $prepared,
            'The "post_type" was not included in the prepared template part.');
        $this->assertObjectHasProperty('post_status', $prepared,
            'The "post_status" was not included in the prepared template part.');
        $this->assertObjectHasProperty('tax_input', $prepared,
            'The "tax_input" was not included in the prepared template part.');
        $this->assertArrayHasKey('wp_theme', $prepared->tax_input,
            'The "wp_theme" tax was not included in the prepared template part.');
        $this->assertArrayHasKey('wp_template_part_area', $prepared->tax_input,
            'The "wp_template_part_area" tax was not included in the prepared template part.');
        $this->assertObjectHasProperty('post_content', $prepared,
            'The "post_content" was not included in the prepared template part.');
        $this->assertObjectHasProperty('post_title', $prepared,
            'The "post_title" was not included in the prepared template part.');

        $this->assertSame('wp_template_part', $prepared->post_type,
            'The "post_type" in the prepared template part should be "wp_template_part".');
        $this->assertSame('publish', $prepared->post_status,
            'The post status in the prepared template part should be "publish".');
        $this->assertSame(WP_TEMPLATE_PART_AREA_UNCATEGORIZED, $prepared->tax_input['wp_template_part_area'],
            'The area in the prepared template part should be uncategorized.');
        $this->assertSame('Untitled Template Part', $prepared->post_title,
            'The title was not correct in the prepared template part.');
