...
class Tests_Blocks_RenderReusableCommentTemplate extends WP_UnitTestCase
{
    ...
    public function test_rendering_comment_template()
    {
        ...
        $this->assertSame(
            str_replace(["\n", "\t"], '', '<ol class="wp-block-comment-template"><li id="comment-'
                . self::$comment_ids[0]
                . '" class="comment even thread-even depth-1"><div class="wp-block-comment-author-name"><a rel="external nofollow ugc" href="http://example.com/author-url/" target="_self" >Test</a></div><div class="wp-block-comment-content"><p>Hello world</p></div></li></ol>'),
            str_replace(["\n", "\t"], '', $block->render()),
        );
    }
    ...
    public function test_render_block_core_comment_content_converts_to_html()
    {
        ...
        $this->assertSame(
            '<ol class="wp-block-comment-template"><li id="comment-'
            . self::$comment_ids[0]
            . '" class="comment even thread-even depth-1"><div class="wp-block-comment-content">'
            . $expected_content
            . '</div></li></ol>',
            $block->render(),
        );
    ...
    public function test_rendering_comment_template_unmoderated_preview()
    {
        ...
        $this->assertSame(
            '<ol class="wp-block-comment-template"><li id="comment-'
            . self::$comment_ids[0]
            . '" class="comment even thread-even depth-1"><div class="wp-block-comment-author-name"><a rel="external nofollow ugc" href="http://example.com/author-url/" target="_self" >Test</a></div><div class="wp-block-comment-content"><p>Hello world</p></div></li><li id="comment-'
            . $unapproved_comment[0]
            . '" class="comment odd alt thread-odd thread-alt depth-1"><div class="wp-block-comment-author-name">Visitor</div><div class="wp-block-comment-content"><p><em class="comment-awaiting-moderation">Your comment is awaiting moderation.</em></p>Hi there! My comment needs moderation.</div></li></ol>',
            str_replace(["\n", "\t"], '', $block->render()),
        ...
        $render_block_data_callback = static function ($parsed_block) {
            ...
            if ('core/comment-template' === $parsed_block['blockName']) {
                $inserted_block_markup = <<<END
                    <!-- wp:social-links -->
                    <ul class="wp-block-social-links"><!-- wp:social-link {"url":"https://wp.org","service":"wordpress"} /--></ul>
                    <!-- /wp:social-links -->'
                    END;
