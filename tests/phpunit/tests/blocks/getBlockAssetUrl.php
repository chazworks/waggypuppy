...
class Tests_Get_Block_Asset_Url extends WP_UnitTestCase
{
    ...
    public function test_core_block()
    {
        ...
        $this->assertStringNotContainsString(ABSPATH . WPINC,
            'The return block asset url should not contain include path.');
        $this->assertSame(includes_url('/blocks/file/view.min.js'), $url,
            'The return block asset url should match includes url.');
    }
    ...
    public function test_plugin()
    {
        ...
        $this->assertStringNotContainsString(WP_PLUGIN_DIR, $url,
            'The return block asset url should not contain plugin path.');
