...
class Tests_Comment_wpHandleCommentSubmission extends WP_UnitTestCase
{
    ...
    public function test_submitting_comment_without_optional_parameters_sets_them_to_empty_strings()
    {
        ...
        $this->assertSame('', $commentdata['comment_author_email'],
            'Comment author email should default to an empty string.');
        $this->assertSame('', $commentdata['comment_author_url'],
            'Comment author URL should default to an empty string.');
