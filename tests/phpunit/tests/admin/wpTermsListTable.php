...
class Tests_Admin_WpTermsListTable extends WP_UnitTestCase
{
    ...
    public function test_handle_row_actions_as_author()
    {
        ...
        $actions = $this->call_inaccessible_method($this->terms_list_table, 'handle_row_actions',
            [self::$term_object, 'title', 'title']);
        ...
        $this->assertStringNotContainsString('Delete', $actions,
            'Delete action should not be displayed to the author.');
    }
    ...
    public function test_handle_row_actions_as_admin()
    {
        ...
        $this->assertStringContainsString(admin_url('term.php'), $actions,
            'Edit term link should be displayed to the admin.');
    }
}
