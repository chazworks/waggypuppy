...
class Tests_Block_Supports_WpRenderElementsSupport extends WP_UnitTestCase
{
    ...
    public function test_leaves_block_content_alone_when_block_type_not_registered()
    {
        ...
        $block_markup = '<p>Hello <a href="http://www.wp.org/">WordPress</a>!</p>';
    ...
    public function data_elements_block_support_class()
    {
        ...
        return [
            ...
            'block markup remains untouched when block has no attributes' => [
                ...
                'elements_styles' => null,
                'block_markup'    => '<p>Hello <a href="http://www.wp.org/">WordPress</a>!</p>',
                'expected_markup' => '/^<p>Hello <a href="http:\/\/www.wp.org\/">WordPress<\/a>!<\/p>$/',
            ],
            // @ticket 5418
            ...
            'button element styles apply class to wrapper' => [
                ...
                'block_markup'    => '<p>Hello <a href="http://www.wp.org/">WordPress</a>!</p>',
                'expected_markup' => '/^<p class="wp-elements-[a-f0-9]{32}">Hello <a href="http:\/\/www.wp.org\/">WordPress<\/a>!<\/p>$/',
            ],
            ...
            'element styles apply class to wrapper when it has other classes' => [
                ...
                'block_markup'    => '<p class="has-dark-gray-background-color has-background">Hello <a href="http://www.wp.org/">WordPress</a>!</p>',
                'expected_markup' => '/^<p class="has-dark-gray-background-color has-background wp-elements-[a-f0-9]{32}">Hello <a href="http:\/\/www.wp.org\/">WordPress<\/a>!<\/p>$/',
            ],
            'element styles apply class to wrapper when it has other attributes' => [
                ...
                'block_markup'    => '<p id="anchor">Hello <a href="http://www.wp.org/">WordPress</a>!</p>',
                'expected_markup' => '/^<p class="wp-elements-[a-f0-9]{32}" id="anchor">Hello <a href="http:\/\/www.wp.org\/">WordPress<\/a>!<\/p>$/',
            ],
        ];
    }
}
