...
class Tests_Post_WP_Post_Type extends WP_UnitTestCase
{
     ...
     */
    public function test_should_have_correct_custom_revisions_and_autosaves_controllers_properties(
        $property_name,
        $property_value,
        ...
        $this->assertObjectHasProperty($property_name, $post_type,
            "The WP_Post_Type object does not have the expected {$property_name} property.");
        $this->assertSame(
            $expected_property_value,
            $post_type->$property_name,
            sprintf('Expected the property "%s" to have the %s value.', $property_name,
                var_export($expected_property_value, true)),
        );
    }
     ...
     */
    public function test_get_revisions_rest_controller_should_return_correct_values(
        $show_in_rest,
        $supports_revisions,
        $revisions_rest_controller_class,
        $expected_value,
     ...
     * @param string|null $expected_value Expected value.
     */
    public function test_get_autosave_rest_controller_should_return_correct_values(
        $show_in_rest,
        $post_type,
        $autosave_rest_controller_class,
        $expected_value,
