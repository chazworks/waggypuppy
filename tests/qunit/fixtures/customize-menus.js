...
window._wpCustomizeSettings.sections.menu_locations = {
	id: 'menu_locations',
	description:
		'<p>Your theme contains 1 menu location. Select which menu you would like to use.</p><p>You can also place menus in widget areas with the Custom Menu widget.</p>',
	priority: 5,
	panel: 'nav_menus',
	type: 'default',
...
window._wpCustomizeSettings.controls[ 'nav_menu_item[2000]' ] = {
	...
	classes: '',
	content:
		'<li id="customize-control-nav_menu_item-2000" class="customize-control customize-control-nav_menu_item"> </li>',
	depth: 0,
	description: '',
	el_classes:
		'menu-item menu-item-depth-0 menu-item-page menu-item-edit-inactive',
	instanceNumber: 42,
	item_type: 'post_type',
...
window._wpCustomizeSettings.controls[ 'nav_menu_item[2001]' ] = {
	...
	classes: '',
	content:
		'<li id="customize-control-nav_menu_item-2001" class="customize-control customize-control-nav_menu_item"> </li>',
	depth: 0,
	description: '',
	el_classes:
		'menu-item menu-item-depth-0 menu-item-custom menu-item-edit-inactive',
	instanceNumber: 46,
	item_type: 'custom',
...
window._wpCustomizeSettings.controls[ 'nav_menu_item[2002]' ] = {
	...
	classes: '',
	content:
		'<li id="customize-control-nav_menu_item-2002" class="customize-control customize-control-nav_menu_item"> </li>',
	depth: 0,
	description: '',
	el_classes:
		'menu-item menu-item-depth-0 menu-item-custom menu-item-edit-inactive',
...
window._wpCustomizeSettings.controls.new_menu_name = {
	...
	section: 'add_menu',
	content:
		'<li id="customize-control-new_menu_name" class="customize-control customize-control-text"> <label> <input type="text" class="menu-name-field" placeholder="New menu name"  value="" data-customize-setting-link="new_menu_name" /> </label> </li>',
	label: '',
	description: '',
	instanceNumber: 46,
};
