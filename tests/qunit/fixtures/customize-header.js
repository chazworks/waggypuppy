...
window._wpCustomizeHeader.uploads = {
	...
	'cropped-cropped-miniature-golden-retriever-puppies-for-sale01127.jpg': {
		...
		thumbnail_url:
			'http://dev.local/2013/11/cropped-cropped-miniature-golden-retriever-puppies-for-sale01127.jpg',
		width: 1600,
		height: 230,
	...
	'cropped-tumblr_m20paq9cjn1qbkdcro1_5003.png': {
		...
		thumbnail_url:
			'http://dev.local/2013/11/cropped-tumblr_m20paq9cjn1qbkdcro1_5003.png',
		width: 1600,
		height: 230,
...
window._wpCustomizeHeader.defaults = {
	circle: {
		...
		thumbnail_url:
			'https://dev.local/wp-content/themes/pub/twentythirteen/images/headers/circle-thumbnail.png',
		description: 'Circle',
	},
	diamond: {
		url: 'https://dev.local/wp-content/themes/pub/twentythirteen/images/headers/diamond.png',
		thumbnail_url:
			'https://dev.local/wp-content/themes/pub/twentythirteen/images/headers/diamond-thumbnail.png',
		description: 'Diamond',
	},
	star: {
		url: 'https://dev.local/wp-content/themes/pub/twentythirteen/images/headers/star.png',
		thumbnail_url:
			'https://dev.local/wp-content/themes/pub/twentythirteen/images/headers/star-thumbnail.png',
		description: 'Star',
	},
};
