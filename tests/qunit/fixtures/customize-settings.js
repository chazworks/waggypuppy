...
customizerRootElement = jQuery(
	'<div id="customize-theme-controls"><ul></ul></div>'
);
...
window._wpCustomizeSettings = {
	...
	controls: {
		'fixture-control': {
			active: true,
			content:
				'<li id="accordion-section-fixture-section" class="accordion-section control-section control-section-default"> <h3 class="accordion-section-title" tabindex="0"> Section Fixture <span class="screen-reader-text">Press return or enter to open</span> </h3> <ul class="accordion-section-content"> <li class="customize-section-description-container"> <div class="customize-section-title"> <button class="customize-section-back" tabindex="-1"> <span class="screen-reader-text">Back</span> </button> <h3> <span class="customize-action">Customizing &#9656; Fixture Panel</span> Section Fixture </h3> </div> </li> </ul> </li>',
			description: '',
			instanceNumber: 8,
	...
	url: {
		activated:
			'http://example.org/wp-admin/themes.php?activated=true&previewed',
		ajax: '/wp-admin/admin-ajax.php',
		allowed: [ 'http://example.org/' ],
		fallback:
			'http://example.org/?preview=1&template=twentyfifteen&stylesheet=twentyfifteen&preview_iframe=1&TB_iframe=true',
