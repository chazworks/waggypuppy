...
window._wpCustomizeSettings.settings[ 'widget_search[2]' ] = {
	value: {
		encoded_serialized_instance:
			'YToxOntzOjU6InRpdGxlIjtzOjY6IkJ1c2NhciI7fQ==',
		title: 'Buscar',
...
window._wpCustomizeSettings.controls[ 'widget_search[2]' ] = {
	...
	content:
		'<li id="customize-control-widget_search-2" class="customize-control customize-control-widget_form"> </li>',
	label: 'Search',
	description: '',
	instanceNumber: 2,
	widget_id: 'search-2',
...
window._wpCustomizeSettings.controls[ 'sidebars_widgets[sidebar-1]' ] = {
	...
	section: 'sidebar-widgets-sidebar-1',
	content:
		'<li id="customize-control-sidebars_widgets-sidebar-1" class="customize-control customize-control-sidebar_widgets"> <span class="button add-new-widget" tabindex="0">    Add a Widget  </span> <span class="reorder-toggle" tabindex="0"> <span class="reorder">Reorder</span> <span class="reorder-done">Done</span> </span> </li>',
	label: '',
	description: '',
	instanceNumber: 1,
	sidebar_id: 'sidebar-1',
