...
module.exports = function ( grunt ) {
	...
	grunt.initConfig( {
		postcss: {
			...
			core: {
				...
				cwd: SOURCE_DIR,
				dest: SOURCE_DIR,
				src: [ 'wp-admin/css/*.css', 'wp-includes/css/*.css' ],
			},
			colors: {
				expand: true,
				cwd: WORKING_DIR,
				dest: WORKING_DIR,
				src: [ 'wp-admin/css/colors/*/colors.css' ],
			},
		},
		usebanner: {
			options: {
			...
			default_options: {
				files: [
					...
					},
					{
						append: 'jQuery.noConflict();',
						input:
							WORKING_DIR + 'wp-includes/js/jquery/jquery.min.js',
						output:
							WORKING_DIR + 'wp-includes/js/jquery/jquery.min.js',
					},
				],
		...
		copy: {
			...
			'npm-packages': {
				files: [
					{
						[ WORKING_DIR + 'wp-includes/js/backbone.js' ]: [
							'./node_modules/backbone/backbone.js',
						],
						[ WORKING_DIR + 'wp-includes/js/clipboard.js' ]: [
							'./node_modules/clipboard/dist/clipboard.js',
						],
						[ WORKING_DIR + 'wp-includes/js/hoverIntent.js' ]: [
						...
						[ WORKING_DIR + 'wp-includes/js/imagesloaded.min.js' ]:
							[
								'./node_modules/imagesloaded/imagesloaded.pkgd.min.js',
							],
						[ WORKING_DIR + 'wp-includes/js/jquery/jquery.js' ]: [
						...
						[ WORKING_DIR + 'wp-includes/js/masonry.min.js' ]: [
							'./node_modules/masonry-layout/dist/masonry.pkgd.min.js',
						],
						[ WORKING_DIR + 'wp-includes/js/underscore.js' ]: [
				...
				files: [
					...
					WORKING_DIR === SOURCE_DIR
						? {
								expand: true,
								cwd:
									SOURCE_DIR + 'js/_enqueues/vendor/tinymce/',
								src: 'tinymce.js',
			...
			'admin-js': {
				files: {
					[ WORKING_DIR + 'wp-admin/js/accordion.js' ]: [
						'./src/js/_enqueues/lib/accordion.js',
					],
					[ WORKING_DIR + 'wp-admin/js/application-passwords.js' ]: [
						'./src/js/_enqueues/admin/application-passwords.js',
					],
					[ WORKING_DIR + 'wp-admin/js/auth-app.js' ]: [
						'./src/js/_enqueues/admin/auth-app.js',
					],
					[ WORKING_DIR + 'wp-admin/js/code-editor.js' ]: [
						'./src/js/_enqueues/wp/code-editor.js',
					],
					[ WORKING_DIR + 'wp-admin/js/color-picker.js' ]: [
						'./src/js/_enqueues/lib/color-picker.js',
					],
					[ WORKING_DIR + 'wp-admin/js/comment.js' ]: [
						'./src/js/_enqueues/admin/comment.js',
					],
					[ WORKING_DIR + 'wp-admin/js/common.js' ]: [
						'./src/js/_enqueues/admin/common.js',
					],
					[ WORKING_DIR + 'wp-admin/js/custom-background.js' ]: [
						'./src/js/_enqueues/admin/custom-background.js',
					],
					[ WORKING_DIR + 'wp-admin/js/custom-header.js' ]: [
						'./src/js/_enqueues/admin/custom-header.js',
					],
					[ WORKING_DIR + 'wp-admin/js/customize-controls.js' ]: [
						'./src/js/_enqueues/wp/customize/controls.js',
					],
					[ WORKING_DIR + 'wp-admin/js/customize-nav-menus.js' ]: [
						'./src/js/_enqueues/wp/customize/nav-menus.js',
					],
					[ WORKING_DIR + 'wp-admin/js/customize-widgets.js' ]: [
						'./src/js/_enqueues/wp/customize/widgets.js',
					],
					[ WORKING_DIR + 'wp-admin/js/dashboard.js' ]: [
						'./src/js/_enqueues/wp/dashboard.js',
					],
					[ WORKING_DIR + 'wp-admin/js/edit-comments.js' ]: [
						'./src/js/_enqueues/admin/edit-comments.js',
					],
					[ WORKING_DIR + 'wp-admin/js/editor-expand.js' ]: [
						'./src/js/_enqueues/wp/editor/dfw.js',
					],
					[ WORKING_DIR + 'wp-admin/js/editor.js' ]: [
						'./src/js/_enqueues/wp/editor/base.js',
					],
					[ WORKING_DIR + 'wp-admin/js/gallery.js' ]: [
						'./src/js/_enqueues/lib/gallery.js',
					],
					[ WORKING_DIR + 'wp-admin/js/image-edit.js' ]: [
						'./src/js/_enqueues/lib/image-edit.js',
					],
					[ WORKING_DIR + 'wp-admin/js/inline-edit-post.js' ]: [
						'./src/js/_enqueues/admin/inline-edit-post.js',
					],
					[ WORKING_DIR + 'wp-admin/js/inline-edit-tax.js' ]: [
						'./src/js/_enqueues/admin/inline-edit-tax.js',
					],
					[ WORKING_DIR + 'wp-admin/js/language-chooser.js' ]: [
						'./src/js/_enqueues/lib/language-chooser.js',
					],
					[ WORKING_DIR + 'wp-admin/js/link.js' ]: [
						'./src/js/_enqueues/admin/link.js',
					],
					[ WORKING_DIR + 'wp-admin/js/media-gallery.js' ]: [
						'./src/js/_enqueues/deprecated/media-gallery.js',
					],
					[ WORKING_DIR + 'wp-admin/js/media-upload.js' ]: [
						'./src/js/_enqueues/admin/media-upload.js',
					],
					[ WORKING_DIR + 'wp-admin/js/media.js' ]: [
						'./src/js/_enqueues/admin/media.js',
					],
					[ WORKING_DIR + 'wp-admin/js/nav-menu.js' ]: [
						'./src/js/_enqueues/lib/nav-menu.js',
					],
					[ WORKING_DIR + 'wp-admin/js/password-strength-meter.js' ]:
						[ './src/js/_enqueues/wp/password-strength-meter.js' ],
					[ WORKING_DIR + 'wp-admin/js/password-toggle.js' ]: [
						'./src/js/_enqueues/admin/password-toggle.js',
					],
					[ WORKING_DIR + 'wp-admin/js/plugin-install.js' ]: [
						'./src/js/_enqueues/admin/plugin-install.js',
					],
					[ WORKING_DIR + 'wp-admin/js/post.js' ]: [
						'./src/js/_enqueues/admin/post.js',
					],
					[ WORKING_DIR + 'wp-admin/js/postbox.js' ]: [
						'./src/js/_enqueues/admin/postbox.js',
					],
					[ WORKING_DIR + 'wp-admin/js/revisions.js' ]: [
						'./src/js/_enqueues/wp/revisions.js',
					],
					[ WORKING_DIR + 'wp-admin/js/set-post-thumbnail.js' ]: [
						'./src/js/_enqueues/admin/set-post-thumbnail.js',
					],
					[ WORKING_DIR + 'wp-admin/js/svg-painter.js' ]: [
						'./src/js/_enqueues/wp/svg-painter.js',
					],
					[ WORKING_DIR + 'wp-admin/js/tags-box.js' ]: [
						'./src/js/_enqueues/admin/tags-box.js',
					],
					[ WORKING_DIR + 'wp-admin/js/tags-suggest.js' ]: [
						'./src/js/_enqueues/admin/tags-suggest.js',
					],
					[ WORKING_DIR + 'wp-admin/js/tags.js' ]: [
						'./src/js/_enqueues/admin/tags.js',
					],
					[ WORKING_DIR + 'wp-admin/js/site-health.js' ]: [
						'./src/js/_enqueues/admin/site-health.js',
					],
					[ WORKING_DIR + 'wp-admin/js/site-icon.js' ]: [
						'./src/js/_enqueues/admin/site-icon.js',
					],
					[ WORKING_DIR + 'wp-admin/js/privacy-tools.js' ]: [
						'./src/js/_enqueues/admin/privacy-tools.js',
					],
					[ WORKING_DIR + 'wp-admin/js/theme-plugin-editor.js' ]: [
						'./src/js/_enqueues/wp/theme-plugin-editor.js',
					],
					[ WORKING_DIR + 'wp-admin/js/theme.js' ]: [
						'./src/js/_enqueues/wp/theme.js',
					],
					[ WORKING_DIR + 'wp-admin/js/updates.js' ]: [
						'./src/js/_enqueues/wp/updates.js',
					],
					[ WORKING_DIR + 'wp-admin/js/user-profile.js' ]: [
						'./src/js/_enqueues/admin/user-profile.js',
					],
					[ WORKING_DIR + 'wp-admin/js/user-suggest.js' ]: [
					...
					[ WORKING_DIR + 'wp-admin/js/widgets/media-widgets.js' ]: [
						'./src/js/_enqueues/wp/widgets/media.js',
					],
					[ WORKING_DIR + 'wp-admin/js/widgets/text-widgets.js' ]: [
						'./src/js/_enqueues/wp/widgets/text.js',
					],
					[ WORKING_DIR + 'wp-admin/js/widgets.js' ]: [
						'./src/js/_enqueues/admin/widgets.js',
					],
					[ WORKING_DIR + 'wp-admin/js/word-count.js' ]: [
						'./src/js/_enqueues/wp/utils/word-count.js',
					],
					[ WORKING_DIR + 'wp-admin/js/wp-fullscreen-stub.js' ]: [
						'./src/js/_enqueues/deprecated/fullscreen-stub.js',
					],
					[ WORKING_DIR + 'wp-admin/js/xfn.js' ]: [
			...
			'includes-js': {
				files: {
					[ WORKING_DIR + 'wp-includes/js/admin-bar.js' ]: [
						'./src/js/_enqueues/lib/admin-bar.js',
					],
					[ WORKING_DIR + 'wp-includes/js/api-request.js' ]: [
						'./src/js/_enqueues/wp/api-request.js',
					],
					[ WORKING_DIR + 'wp-includes/js/autosave.js' ]: [
						'./src/js/_enqueues/wp/autosave.js',
					],
					[ WORKING_DIR + 'wp-includes/js/comment-reply.js' ]: [
						'./src/js/_enqueues/lib/comment-reply.js',
					],
					[ WORKING_DIR + 'wp-includes/js/customize-base.js' ]: [
						'./src/js/_enqueues/wp/customize/base.js',
					],
					[ WORKING_DIR + 'wp-includes/js/customize-loader.js' ]: [
						'./src/js/_enqueues/wp/customize/loader.js',
					],
					[ WORKING_DIR + 'wp-includes/js/customize-models.js' ]: [
					...
					[ WORKING_DIR + 'wp-includes/js/customize-preview.js' ]: [
					...
					[ WORKING_DIR + 'wp-includes/js/customize-views.js' ]: [
						'./src/js/_enqueues/wp/customize/views.js',
					],
					[ WORKING_DIR + 'wp-includes/js/heartbeat.js' ]: [
						'./src/js/_enqueues/wp/heartbeat.js',
					],
					[ WORKING_DIR + 'wp-includes/js/mce-view.js' ]: [
						'./src/js/_enqueues/wp/mce-view.js',
					],
					[ WORKING_DIR + 'wp-includes/js/media-editor.js' ]: [
						'./src/js/_enqueues/wp/media/editor.js',
					],
					[ WORKING_DIR + 'wp-includes/js/quicktags.js' ]: [
						'./src/js/_enqueues/lib/quicktags.js',
					],
					[ WORKING_DIR + 'wp-includes/js/shortcode.js' ]: [
						'./src/js/_enqueues/wp/shortcode.js',
					],
					[ WORKING_DIR + 'wp-includes/js/utils.js' ]: [
						'./src/js/_enqueues/lib/cookies.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-ajax-response.js' ]: [
						'./src/js/_enqueues/lib/ajax-response.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-api.js' ]: [
						'./src/js/_enqueues/wp/api.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-auth-check.js' ]: [
						'./src/js/_enqueues/lib/auth-check.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-backbone.js' ]: [
						'./src/js/_enqueues/wp/backbone.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-custom-header.js' ]: [
						'./src/js/_enqueues/wp/custom-header.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-embed-template.js' ]: [
						'./src/js/_enqueues/lib/embed-template.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-embed.js' ]: [
						'./src/js/_enqueues/wp/embed.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-emoji-loader.js' ]: [
						'./src/js/_enqueues/lib/emoji-loader.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-emoji.js' ]: [
						'./src/js/_enqueues/wp/emoji.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-list-revisions.js' ]: [
						'./src/js/_enqueues/lib/list-revisions.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-lists.js' ]: [
						'./src/js/_enqueues/lib/lists.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-pointer.js' ]: [
						'./src/js/_enqueues/lib/pointer.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-sanitize.js' ]: [
						'./src/js/_enqueues/wp/sanitize.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wp-util.js' ]: [
						'./src/js/_enqueues/wp/util.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wpdialog.js' ]: [
						'./src/js/_enqueues/lib/dialog.js',
					],
					[ WORKING_DIR + 'wp-includes/js/wplink.js' ]: [
						'./src/js/_enqueues/lib/link.js',
					],
					[ WORKING_DIR + 'wp-includes/js/zxcvbn-async.js' ]: [
			...
			core: {
				...
				filter: function ( filepath ) {
					...
					if (
						filepath === file ||
						( -1 !== index &&
							index === filepath.length - ( file.length + 1 ) )
					) {
						return true;
					}
		...
		qunit: {
			files: [ 'tests/qunit/**/*.html', '!tests/qunit/editor/**' ],
		},
		phpunit: {
			default: {
		...
		concat: {
			tinymce: {
				...
				src: [
					...
					WORKING_DIR +
						'wp-includes/js/tinymce/plugins/*/plugin.min.js',
				],
			...
			options: {
				file_mappings: {
					'src/wp-admin/js/accordion.js':
						'src/js/_enqueues/lib/accordion.js',
					'src/wp-admin/js/application-passwords.js':
						'src/js/_enqueues/admin/application-passwords.js',
					'src/wp-admin/js/auth-app.js':
						'src/js/_enqueues/admin/auth-app.js',
					...
					'src/wp-includes/js/wp-emoji.js':
						'src/js/_enqueues/wp/emoji.js',
					'src/wp-includes/js/wp-list-revisions.js':
						'src/js/_enqueues/lib/list-revisions.js',
					...
					'src/wp-includes/js/media/views/attachments/audio-details.js':
						'src/js/media/views/attachments/audio-details.js',
					'src/wp-includes/js/media/views/attachments/button-group.js':
						'src/js/media/views/attachments/button-group.js',
					'src/wp-includes/js/media/views/attachments/button.js':
						'src/js/media/views/attachments/button.js',
					...
					patterns: [
						{
							...
							replacement: function () {
								...
								if ( 0 !== ghCli.status ) {
									grunt.fatal(
										'Emoji precommit script requires GitHub CLI. See https://cli.github.com/.'
									);
								}

								// Fetch a list of the files that Twemoji supplies.
								query =
									'query={repository(owner: "jdecked", name: "twemoji") {object(expression: "v15.0.3:assets/svg") {... on Tree {entries {name}}}}}';
								files = spawn( 'gh', [
									'api',
									'graphql',
									'-f',
								...
								if ( 0 !== files.status ) {
									grunt.fatal(
										'Unable to fetch Twemoji file list'
									);
								}
								...
								try {
									...
									grunt.fatal(
										'Unable to parse Twemoji file list'
									);
								}
								entities =
									apiResponse.data.repository.object.entries;
								entities = entities.reduce( function (
									accumulator,
									val
								) {
									return accumulator + val.name + '\n';
								},
								'' );
								...
								partials = entities = entities.replace(
									/([a-z0-9]+)/g,
									'&#x$1;'
								);
				...
				files: [
					{
						expand: true,
						flatten: true,
						src: [ SOURCE_DIR + 'wp-includes/formatting.php' ],
				...
				files: [
					{
						expand: true,
						flatten: true,
						src: [ BUILD_DIR + 'wp-includes/js/underscore.js' ],
		...
		_watch: {
			...
			test: {
				files: [ 'tests/qunit/**', '!tests/qunit/editor/**' ],
				tasks: [ 'qunit' ],
			},
		},
	} );
	...
	grunt.registerTask( 'watch', function () {
		...
		if (
			'watch:phpunit' === grunt.cli.tasks[ 0 ] ||
			'undefined' !== typeof grunt.option( 'phpunit' )
		) {
	...
	grunt.registerTask( 'precommit:image', [ 'imagemin:core' ] );
	...
	grunt.registerTask( 'precommit:css', [ 'postcss:core' ] );

	grunt.registerTask( 'precommit:php', [ 'phpunit' ] );

	grunt.registerTask( 'precommit:emoji', [ 'replace:emoji-regex' ] );

	grunt.registerTask(
		'precommit',
		'Runs test and build tasks in preparation for a commit',
		function () {
			var done = this.async();
			var map = {
			...
			function runAllTasks() {
				grunt.log.writeln(
					'Cannot determine which files are modified as SVN and GIT are not available.'
				);
					...
					function ( error, result, code ) {
						...
						if ( code === 0 ) {
							if (
								...
								grunt.log.writeln(
									'Configuration files modified. Running `prerelease`.'
								);
								taskList.push( 'prerelease' );
							} else {
								if (
									[ 'png', 'jpg', 'gif', 'jpeg' ].some(
										testExtension
									)
								) {
									grunt.log.writeln(
										'Image files modified. Minifying.'
									);
									taskList.push( 'precommit:image' );
								}

								[ 'js', 'css', 'php' ].forEach( function (
									extension
								) {
								...
								if ( [ 'twemoji.js' ].some( testPath ) ) {
									grunt.log.writeln(
										'twemoji.js has updated. Running `precommit:emoji.'
									);
								...
								if ( testExtension( 'php' ) ) {
									grunt.log.writeln(
										'PHP files modified. Code formatting will be run.'
									);
									var PHPfiles = result.stdout.split( '\n' );

									// Find .php files that have been modified or added.
									PHPfiles = PHPfiles.filter( function (
										file
									) {
										return /^\s*[MA]\s*.*\.php$/.test(
											file
										);
									} );
	...
	grunt.registerTask(
		'copy:block-json',
		'Copies block.json file contents to block-json.php.',
		function () {
			var blocks = {};
			grunt.file.recurse(
	...
	grunt.registerTask( 'verify:source-maps', function () {
		...
		files
			...
			.forEach( function ( file ) {
				...
				const doesNotHaveSourceMap =
					! /^\/\/# sourceMappingURL=((?!data:).)/m.test( contents );
	...
	grunt.registerTask( 'build', function () {
		if ( grunt.option( 'dev' ) ) {
			grunt.task.run( [ 'build:js', 'build:css' ] );
		} else {
			grunt.task.run( [
				'build:files',
				'build:js',
	...
	grunt.registerMultiTask(
		...
		function () {
			var args = phpUnitWatchGroup
				? this.data.args.concat( [ '--group', phpUnitWatchGroup ] )
				: this.data.args;
	...
	grunt.registerTask(
		'format:php',
		'Runs the code formatter on changed files.',
		function () {
			var done = this.async();
	...
	grunt.registerTask(
		'lint:php',
		'Runs the code linter on changed files.',
		function () {
			var done = this.async();
			var flags = this.flags;
			var args = changedFiles.php;
	...
	grunt.registerTask(
		'wp-packages:update',
		'Update waggypuppy packages',
		function () {
			const distTag = grunt.option( 'dist-tag' ) || 'latest';
			grunt.log.writeln(
				`Updating waggypuppy packages (--dist-tag=${ distTag })`
			);
			spawn(
				'npx',
				[ 'wp-scripts', 'packages-update', `--dist-tag=${ distTag }` ],
				{
					cwd: __dirname,
					stdio: 'inherit',
				}
	...
	grunt.registerTask(
		'browserslist:update',
		'Update the local database of browser supports',
		function () {
	...
	grunt.registerTask(
		...
		'Update version of dependencies in package.json to match the ones listed in the latest waggypuppy packages',
		function () {
			const distTag = grunt.option( 'dist-tag' ) || 'latest';
			grunt.log.writeln(
				`Updating versions of dependencies listed in package.json (--dist-tag=${ distTag })`
			);
			spawn(
				'node',
				[
	...
	grunt.registerTask(
		'wp-packages:sync-stable-blocks',
		'Refresh the PHP files referring to stable @wordpress/block-library blocks.',
		function () {
			grunt.log.writeln(
				`Syncing stable blocks from @wordpress/block-library to src/`
			);
	...
	grunt.event.on( 'watch', function ( action, filepath, target ) {
		...
		if (
			[ 'all', 'rtl', 'webpack', 'js-enqueues', 'js-webpack' ].indexOf(
				target
			) === -1
		) {
			return;
		...
		if ( target === 'js-enqueues' ) {
			...
			if (
				filepath.indexOf( SOURCE_DIR + 'js/_enqueues/vendor/' ) === 0
			) {
				...
				for ( dest in configs ) {
					...
					if (
						dest &&
						configs.hasOwnProperty( dest ) &&
						configs[ dest ][ 0 ] === './' + filepath
					) {
